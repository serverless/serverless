...
menuText: Docs
description: An introduction to the Serverless Framework and its concepts
layout: Doc
-->

# Intro

The Serverless Framework allows you to easily build applications on new serverless compute services, like [AWS Lambda](https://aws.amazon.com/lambda/).
...
* *[And more...](./02-providers/aws/events/README.md)*
