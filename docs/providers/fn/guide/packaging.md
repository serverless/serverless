<!--
title: Serverless Framework - Fn Guide - Packaging
menuText: Packaging
menuOrder: 10
description: How the Serverless Framework packages your Fn functions and other available options
layout: Doc
-->

<!-- DOCS-SITE-LINK:START automatically generated  -->
### [Read this on the main serverless docs site](https://www.serverless.com/framework/docs/providers/Fn/guide/packaging)
<!-- DOCS-SITE-LINK:END -->
...
Using the Serverless CLI tool, you can package your project without deploying with Fn. This is best used with CI / CD workflows to ensure consistent deployable artifacts.
