...
### [Read this on the main serverless docs site](https://www.serverless.com/framework/docs/providers/knative/)

<!-- DOCS-SITE-LINK:END -->

# Knative Provider Documentation
...
<div class="docsSections">
  ...
  <div class="docsSection">
    ...
    <div class="docsProviderItems">
      <ul>
        <li><a href="./events/custom.md">Custom</a></li>
        <li><a href="./events/kafka.md">Kafka</a></li>
        <li><a href="./events/gcp-pub-sub.md">Google Cloud PubSub</a></li>
        <li><a href="./events/aws-sqs.md">AWS SQS</a></li>
        <li><a href="./events/cron.md">Cron</a></li>
      </ul>
    </div>
  </div>
