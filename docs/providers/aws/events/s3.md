...
If you need to configure the bucket itself, you'll need to add an id property to the s3 event configuration. The id property should be the same as your resource logical id. Example:
