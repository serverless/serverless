...
provider:
  ...
  kmsKeyArn:  arn:aws:kms:XXXXXX:key/key-id  # Overwrite the default KMS key used for secret decryption which is used for all functions
...
functions:
  usersCreate: # A Function
    ...
    kmsKeyArn:  arn:aws:kms:XXXXXX:key/key-id  # Overwrite the default KMS key used for this function
