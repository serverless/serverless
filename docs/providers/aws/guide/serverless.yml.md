...
provider:
  ...
  kmsKeyArn:  arn:aws:kms:XXXXXX:key/key-id  # Overwrite the default KMS key used for encrypting environment variables at rest for all functions
...
functions:
  usersCreate: # A Function
    ...
    kmsKeyArn:  arn:aws:kms:XXXXXX:key/key-id  # Overwrite the default KMS key used for encrypting environment variables at rest for this function
