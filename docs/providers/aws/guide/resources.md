...
|Events::Rule           | <ul><li>**Schedule**: {normalizedFuntionName}EventsRuleSchedule{SequentialID}</li><li>**CloudWatch Events**: {normalizedFuntionName}EventsRuleCloudWatch{SequentialID}</li> </ul> | <ul><li>**Schedule**: HelloEventsRuleSchedule1</li><li>**CloudWatch Events**: HelloEventsRuleCloudWatch1</li></ul>      |
