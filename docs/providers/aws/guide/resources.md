...
|Events::Rule           | <ul><li>**Schedule**: {normalizedFuntionName}EventsRuleSchedule{SequentialID}</li><li>**CloudWatch**: {normalizedFuntionName}EventsRuleCloudWatch{SequentialID}</li> </ul> | <ul><li>**Schedule**: HelloEventsRuleSchedule1</li><li>**CloudWatch**: HelloEventsRuleCloudWatch1</li></ul>      |
