...
### Cloud Formation For Minimum IAM Role Permissions Needed to Get Started

**WARNING:** AWS recommends limiting permissions for IAM Roles to what is needed. While this Cloud Formation provides the _minimum_ permissions needed to get started, as you add functions and services to your app, you'll need to update your permissions. Depending on your needs, it may be simpler to use the default permissions above.
