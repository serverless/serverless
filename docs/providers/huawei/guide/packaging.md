# Huawei Cloud - Packaging

## Package CLI Command

Using the Serverless CLI tool, you can package your project without deploying it to the Huawei Cloud. This is best used with CI / CD workflows to ensure consistent deployable artifacts.
