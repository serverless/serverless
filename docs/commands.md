...
**dash has been deprecated** it will be removed next release (v1.4), in favor of a much more scalable solution (unix style `<file> ...` notation.  Post v1.4 dash will be a super cool web interface.
