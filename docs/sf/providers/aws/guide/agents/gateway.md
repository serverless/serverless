...
- [LangGraph Gateway](https://github.com/serverless/examples/tree/v4/aws-bedrock-agentcore/javascript/langgraph-gateway) - Basic gateway with Lambda tools
...
- [LangGraph Gateway](https://github.com/serverless/examples/tree/v4/aws-bedrock-agentcore/python/langgraph-gateway) - Basic gateway with Lambda tools
