...
* [serverless-elasticommerce-search-service](https://github.com/amimoto-ami/serverless-elasticommerce-search-service) - A backend API that Visualization to relation products search and sales in Ecommerce site. Using APIGateway + Lamdba + DynamoDB.
