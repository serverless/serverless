...
import ensureApiGatewayCloudWatchRole from '../../lib/ensure-api-gateway-cloud-watch-role.js'
  ...
  async compileStage() {
    return pTry(() => {
      ...
      const logGroupLogicalId =
        this.provider.naming.getWebsocketsLogGroupLogicalId()
      ...
      const accessLogging =
        logs.accessLogging == null ? true : logs.accessLogging
