...
export default {
  compileRestApi() {
    ...
    const DisableExecuteApiEndpoint =
      endpoint.disable == null
        ? apiGateway.disableDefaultEndpoint == null
          ? undefined
          : apiGateway.disableDefaultEndpoint
        : endpoint.disable

    const SecurityPolicy = endpoint.securityPolicy || undefined
    const EndpointAccessMode =
      endpoint.accessMode && typeof endpoint.accessMode === 'string'
        ? endpoint.accessMode.toUpperCase()
        : undefined
