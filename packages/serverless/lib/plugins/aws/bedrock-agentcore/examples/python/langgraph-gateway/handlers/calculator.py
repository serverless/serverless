...
def handler(event, context):
    ...
    # Parse input - handle both direct invocation and Gateway format
    ...
    try:
        ...
        print(f"Calculator result: {response}")
        return {
            'statusCode': 200,
...
def safe_calculate(expression: str) -> float:
    ...
    Supports:
    - Basic arithmetic: +, -, *, /, **, %
    - Math functions: sqrt, sin, cos, tan, log, log10, abs, floor, ceil, round
    - Constants: pi, e
    """
...
def _evaluate_node(node):
    ...
    # Legacy number handling (Python < 3.8)
