#!/usr/bin/env node
/**
 * Test script for the LangGraph Custom Code Interpreter agent.
 *
 * Usage:
...
async function main() {
  console.log('LangGraph Custom Code Interpreter Agent Test Suite')
  console.log('='.repeat(50) + '\n')

  console.log('Test 1: Code execution with PUBLIC network\n')
  await invokeAgent(
    'Write Python code that prints the current date and calculates 2^100.',
  )
