...
describe('Serverless Framework Service - Enable Legacy Deployment Bucket through the CLI with direct deployment deployment method', () => {
  ...
  test('Deploy', async () => {
    const options = { stage, c: configFilePath }
    options['enable-legacy-deployment-bucket'] = true
