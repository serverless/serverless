...
describe('updateStack', () => {
  ...
  describe('#createFallback()', () => {
    ...
    it('should create a stack with the CF template URL', () => {
      ...
      const expectedTemplateUrl = `https://s3.amazonaws.com/${awsDeploy.bucketName}/${awsDeploy.serverless.service.package.deploysDirectoryPrefix}/${awsDeploy.serverless.service.package.timestamp}/${compiledTemplateFileName}`;
