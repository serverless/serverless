...
describe('#getLambdaArn()', () => {
  it('should return the Lambda arn', () => {
    ...
    expect(arn).to.equal(
      'arn:aws:lambda:us-east-1:123456:function:some-function',
    )
  })
})
...
describe('#getLambdaArn() govloud west', () => {
  it('should return the govcloud Lambda arn', () => {
    ...
    expect(arn).to.equal(
      'arn:aws-us-gov:lambda:us-gov-west-1:123456:function:some-function',
    )
  })
})
...
describe('#getLambdaArn() govcloud east', () => {
  it('should return the govcloud Lambda arn', () => {
    ...
    expect(arn).to.equal(
      'arn:aws-us-gov:lambda:us-gov-east-1:123456:function:some-function',
    )
  })
})
...
describe('#getLambdaArn() china region', () => {
  it('should return the china Lambda arn', () => {
    ...
    expect(arn).to.equal(
      'arn:aws-cn:lambda:cn-north-1:123456:function:some-function',
    )
  })
})
