...
module.exports = function(config) {
  ...
  CloudFormation.sCreateOrUpdateResourcesStack = function(Serverless, stage, region, stackName) {
    ...
    return CloudFormation.sPutCfFile(
        ...
        .then(function(templateUrl) {
          ...
          if (!stackName) {
            ...
            params.StackName = CloudFormation.sGetResourcesStackName(stage, Serverless._project.name);
