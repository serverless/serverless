...
module.exports = function(config) {
  ...
  CloudFormation.sCreateLambdasStack = function(JAWS, stage, region) {
    ...
    return CloudFormation.sPutCfFile(projRootPath, regionJson.projectBucket, projName, stage, 'lambdas')
  ...
  CloudFormation.sUpdateResourcesStack = function(JAWS, stage, region) {
    ...
    let _this        = this,
        projRootPath = JAWS._projectRootPath,
        bucketName   = JawsUtils.getProjRegionConfigForStage(JAWS._projectJson, stage, region).projectBucket,
        projName     = JAWS._projectJson.name;
