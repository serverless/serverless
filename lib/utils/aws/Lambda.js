...
module.exports = function(config) {
  ...
  Lambda.sGetLambdaArn = function(projectName, componentName, moduleName, functionName, region, awsAccountId) {
    return "arn:aws:lambda:" + region + ":" + awsAccountId + ":function:" + projectName + "-" + componentName + "-" + moduleName + "-" + functionName;
  };
