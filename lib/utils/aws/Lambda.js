...
module.exports = function(config) {
  ...
  Lambda.sGetLambdaName = function(projectJson, functionJson) {
    return sf(projectJson.functionNameTemplate, { projectName: projectJson.name, functionName: functionJson.name});
  };

  Lambda.sGetLambdaRole = function(iamRoleArnLambda, projectJson, stage, functionJson) {
    return sf(iamRoleArnLambda, { projectName: projectJson.name, stageName: stage, functionName: functionJson.name});
  };

  /**
   * Returns [{FunctionName: "", Version: "", FunctionArn: ""},...]
   * @param awsProfile
   * @param awsRegion
   * @param functionNames
