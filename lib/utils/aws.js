...
/**
 * Gets a list of AWS profiles from the filesystem
 *
 * @returns {*}
 */
module.exports.profilesList = function() {
...
module.exports.profilesGet = function(awsProfile) {
  var profiles = this.profilesList();

  if (!profiles[awsProfile]) {
    throw new JawsError('Cant find profile in ~/.aws/credentials', awsProfile);
  }
