...
module.exports.printSummary = async () => {
  ...
  try {
    ...
    try {
      ...
      if (error instanceof EACCESS) {
        log.error('Cannot store information on approached deprecation. Please ensure process has the write access to ~/.servelress directory')
      }
    }
  } finally {
