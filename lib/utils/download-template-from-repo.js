...
import copyDirContentsSync from './fs/copy-dir-contents-sync.js';
import dirExistsSync from './fs/dir-exists-sync.js';
...
function parseGitHubURL(url) {
  ...
  const downloadUrl = `https://${isGitHubEnterprise ? url.hostname : 'github.com'
