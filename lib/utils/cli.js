...
//TODO: can we get rid of some of these now that dash cmd is no longer supported?
...
exports.spinner = function(message) {
  ...
  if (_this.isInteractive()) {
    ...
    spinner = new Spinner('JAWS: ' + chalk.yellow('%s ' + message));
...
exports.generateMainHelp = function(allCommands) {
  ...
  console.log(chalk.dim('Note: pass "--help" after any <context> or <context> <action> for contextual help'));
...
function printHelpAndHomeUrls() {
  console.log(chalk.yellow('JAWS'), 'homepage: http://jawsframework.com');
  console.log(chalk.dim('Visit https://goo.gl/DKCZcq for full help and examples'));
  console.log();
}
