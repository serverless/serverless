...
class ServerlessProviderAws {
  ...
  getCredentials(stage, region) {
    ...
    this.addProfileCredentials(credentials, this._config.profilePrefix);                // allow for user supplied prefix based profile declaration
    ...
    this.addProfileCredentials(credentials, this._config.profilePrefix + '_' + stage);  // allow for *stage specific* user supplied prefix based profile declaration
