...
Jaws.prototype.validateProject = Promise.method(function(checkDupeLambdas) {
  ...
  if (!_this._meta.projectJson || !_this._meta.projectJson.project || !_this._meta.projectJson.project.stages) {
    throw new JawsError(
  ...
  var stages = Object.keys(_this._meta.projectJson.project.stages);
  ...
  var hasOneRegion = stages.some(function(stageName) {
    return !!_this._meta.projectJson.project.stages[stageName][0].region;
  });
