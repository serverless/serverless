...
let Jaws = class Jaws {
  constructor() {
    ...
    this._meta = {
      ...
      projectRootPath: JawsUtils.findProjectRootPath(process.cwd()),
      projectJson: false,
    };
    ...
    if (this._meta.projectRootPath) {
      ...
      this._meta.profile = process.env.JAWS_ADMIN_AWS_PROFILE;
  ...
  getJawsBucket(region, stage) {
    ...
    let _this = this,
        projConfig = JawsUtils.getProjRegionConfigForStage(_this._meta.projectJson, stage, region);
