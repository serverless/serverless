...
const ValidationSchema = require('../lib/classes/ValidationSchema');
...
describe('Serverless', () => {
  ...
  describe('#constructor()', () => {
    ...
    it('should set the ValidationSchema class instance', () => {
      expect(serverless.validationSchema).to.be.instanceof(ValidationSchema);
    });
    ...
    it('should store the ValidationSchema class inside the classes object', () => {
      expect(serverless.classes.ValidationSchema).to.deep.equal(ValidationSchema);
    });
  ...
  describe('#run()', () => {
    ...
    beforeEach(() => {
      ...
      // setup default stubs
      logStatStub = sinon.stub(serverless.utils, 'logStat').resolves();
