...
class Variables {
   ...
   */
  async populateVariables(properties) {
   ...
   */
  async populateMatches(matches, property) {
   ...
   */
  async populateVariable(propertyParam, matchedString, valueToPopulate) {
   ...
   */
  async getDeeperValue(deepProperties, valueToPopulate) {
