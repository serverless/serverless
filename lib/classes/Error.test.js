...
describe('Error', () => {
  ...
  describe('#logError()', () => {
    ...
    it('should exit the process with 1 if the errorReporter is not installed', () => {
      sandbox.stub(errorReporter, 'installed', false);
    ...
    it('should capture the exception and exit the process with 1 if errorReporter is setup', () => {
      sandbox.stub(errorReporter, 'installed', true);
