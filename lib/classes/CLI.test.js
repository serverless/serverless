...
describe('CLI', () => {
  ...
  describe('#displayCommandOptions()', () => {
    let logStub;

    beforeEach(() => {
      cli = new CLI(serverless, []);
      logStub = sinon.stub(cli, 'consoleLog');
    });

    it('should display single simple option', () => {
      const commandObject = {
        options: {
          option1: {
            usage: 'description1',
      ...
      const expectedMessage = chalk.yellow(
        `    --option1 ${chalk.dim('..........................')} description1`
      );

      // Test
      cli.displayCommandOptions(commandObject);

      expect(logStub.callCount).to.be.equal(1);
      expect(logStub.firstCall.args[0]).to.be.equal(expectedMessage);
    });

    it('should display multiple simple options', () => {
      const commandObject = {
        options: {
          option1: {
            usage: 'description1',
      ...
      const expectedMessage1 = chalk.yellow(
        `    --option1 ${chalk.dim('..........................')} description1`
      );
      const expectedMessage2 = chalk.yellow(
        `    --option2 ${chalk.dim('..........................')} description2`
      );
      ...
      expect(logStub.firstCall.args[0]).to.be.equal(expectedMessage1);
      expect(logStub.secondCall.args[0]).to.be.equal(expectedMessage2);
    });

    it('shoudl display shortcut', () => {
      const commandObject = {
        options: {
          option1: {
            usage: 'description1',
      ...
      const expectedMessage = chalk.yellow(
        `    --option1 / -op1 ${chalk.dim('.....................')} description1`
      );
    ...
    it('should add required status', () => {
      ...
      const expectedMessage = chalk.yellow(
        `    --option1 (required) ${chalk.dim('...............')} description1`
      );
    ...
    it('should add shortcut and required status', () => {
      const commandObject = {
        options: {
          option1: {
            usage: 'description1',
      ...
      const expectedMessage = chalk.yellow(
        `    --option1 / -op1 (required) ${chalk.dim('..........')} description1`
      );
