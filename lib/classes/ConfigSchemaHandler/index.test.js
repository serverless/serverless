...
describe('ConfigSchemaHandler', () => {
  ...
  describe('#extendFunctionEventDefinition', () => {
    it('should extend schema with extendFunctionEventDefinition method', async () => {
      ...
      expect(existingEventDefinition.properties).to.have.deep.property(
        'somePluginAdditionalHttpEventProp',
        {
          type: 'string',
        }
      );
      expect(existingEventDefinition.required).to.include('somePluginAdditionalHttpEventProp');
    });
  });
