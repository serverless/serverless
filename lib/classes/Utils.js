...
class Utils {
  ...
  populate(service, data, options) {
    ...
    if (service.variableSyntax) {
      ...
      // temporally change variable syntax from data otherwise it'll match
      if (data.variableSyntax) data.variableSyntax = true;
    }
    ...
    if (data.variableSyntax) data.variableSyntax = varTemplateSyntax;
    return data;
  }
