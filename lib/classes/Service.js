    ...
    return that.serverless.yamlParser
      ...
      .then((serverlessYaml) => {
        ...
        if (!serverlessYaml.functions) {
          throw new SError('"awsCompileFunctions" property is missing in serverless.yaml');
        }
      ...
      .then(() => {
        ...
        if (this.variableSyntax) {
          ...
          // temporally awsRemove variable syntax from service otherwise it'll match
        ...
        // temporally awsRemove environment obj. Doesn't make sense to
            ...
            val.match(varTemplateSyntax).forEach((variableSyntax) => {
              ...
              if (!value && !value !== '') {
                ...
                if (typeof value === 'object') {
                  ...
                  // awsRemove first element. It's the variableName
