  ...
  async validate() {
    ...
    if (userConfig.projectDir != null) {
      this.serverless._logDeprecation(
        'PROJECT_DIR',
        'Starting with next major release, "projectDir" property will no longer be recognized. ' +
    ...
    if (userConfig.variablesResolutionMode != null) {
      this.serverless._logDeprecation(
        ...
        'Starting with next major release, "variablesResolutionMode" property will no longer be recognized. ' +
          'Please remove it from configuration'
      );
    }
    return this;
