...
describe('Service', () => {
  ...
  describe('#loadServiceFileParam', () => {
    ...
    it('should throw an error when "plugins" param defined as string uses variables', () => {
      ...
      ).to.throw('Using variables in plugins section is not allowed');
    });

    it('should throw an error when "plugins" param defined as array uses variables', () => {
      const serverlessFileParam = {
        service: 'some-service',
