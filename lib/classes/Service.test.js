...
describe('Service', () => {
  describe('#constructor()', () => {
    ...
    it('should construct with defaults', () => {
      ...
      expect(serviceInstance.configValidationMode).to.equal('warn');
    });
  ...
  describe('#validate()', () => {
    ...
    it('should call configSchemaHandler.validateConfig', () => {
      const serverless = new Serverless();
      const serviceInstance = new Service(serverless);
      const validateConfigStub = sinon.stub(serverless.configSchemaHandler, 'validateConfig');
      serviceInstance.validate();
      expect(validateConfigStub.called).to.be.true;
    });
