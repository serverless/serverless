  ...
  describe('#getValueFromSource()', () => {
    ...
    beforeEach(() => {
      getValueFromSlsStub = sinon
        .stub(serverless.variables.variableResolvers[0], 'method')
        .resolves('variableValue');
      getValueFromEnvStub = sinon
        .stub(serverless.variables.variableResolvers[1], 'method')
        .resolves('variableValue');
      getValueFromOptionsStub = sinon
        .stub(serverless.variables.variableResolvers[2], 'method')
        .resolves('variableValue');
      getValueFromSelfStub = sinon
        .stub(serverless.variables.variableResolvers[3], 'method')
        .resolves('variableValue');
      getValueFromFileStub = sinon
        .stub(serverless.variables.variableResolvers[4], 'method')
        .resolves('variableValue');
      getValueFromCfStub = sinon
        .stub(serverless.variables.variableResolvers[5], 'method')
        .resolves('variableValue');
      getValueFromS3Stub = sinon
        .stub(serverless.variables.variableResolvers[6], 'method')
        .resolves('variableValue');
      getValueFromSsmStub = sinon
        .stub(serverless.variables.variableResolvers[8], 'method')
        .resolves('variableValue');
    });

    afterEach(() => {
      serverless.variables.variableResolvers[0].method.restore();
      serverless.variables.variableResolvers[1].method.restore();
      serverless.variables.variableResolvers[2].method.restore();
      serverless.variables.variableResolvers[3].method.restore();
      serverless.variables.variableResolvers[4].method.restore();
      serverless.variables.variableResolvers[5].method.restore();
      serverless.variables.variableResolvers[6].method.restore();
      serverless.variables.variableResolvers[8].method.restore();
    });
    ...
    describe('caching', () => {
      const sources = [
        ...
        { functionIndex: 5, function: 'getValueFromCf', variableString: 'cf:test-stack.testOutput' },
        { functionIndex: 6, function: 'getValueFromS3', variableString: 's3:test-bucket/path/to/ke' },
        { functionIndex: 8, function: 'getValueFromSsm', variableString: 'ssm:/test/path/to/param' },
      ];
      sources.forEach(source => {
        it(`should only call ${source.function} once, returning the cached value otherwise`, () => {
          const getValueFunctionStub = serverless.variables.variableResolvers[source.functionIndex].method;
