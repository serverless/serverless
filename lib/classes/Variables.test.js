...
describe('Variables', () => {
  ...
  describe('#populateObject()', () => {
    ...
    describe('significant variable usage corner cases', () => {
      ...
      it('should properly render embedded variables', () => {
        service.custom = {
          val0: 'my value 0',
          val1: '0',
      ...
      it('should properly render overwrites where the first value is valid', () => {
        service.custom = {
          val0: 'my value',
      ...
      it('should properly render overwrites where the middle value is valid', () => {
        service.custom = {
          val0: 'my value',
      ...
      it('should properly render overwrites where the last value is valid', () => {
        service.custom = {
          val0: 'my value',
      ...
      // https://github.com/serverless/serverless/issues/4527
...
//       it('should render any given variable only once', () => {
//         makeAsyncLoadJs();
//         service.custom = {
//           val1: '${self:custom.val0}',
//           val2: '${self:custom.val1}',
//           val0: '${file(async.load.js):str}',
//         };
//         const expected = {
...
//       });
//       it(
//         'should render any given variable only once regardless of ordering or reference count',
//         () => {
//           makeAsyncLoadJs();
//           service.custom = {
...
//       );
      it(
        'should render async objects with contained variables',
        () => {
          makeAsyncLoadJs();
  ...
  describe('#getValueFromSource()', () => {
    ...
    /*
     * !! THESE tests have to be adapted to run in the context of getValueFromSource now !!
     * !! SEE THE MOVED TEST BELOW
     *
    ...
    it('should NOT call populateObject if variable value is a circular object', () => {
      ...
      serverless.variables.populatedObjectReferences['opt:stage'] = variableValuePopulated;
