  ...
  describe('fallback', () => {
    ...
    describe('aws-specific syntax', () => {
      ...
      beforeEach(() => {
        ...
        requestStub = sinon.stub(awsProvider, 'request').callsFake(() =>
  ...
  describe('#populateObject()', () => {
    ...
    it('should persist keys with dot notation', () => {
      ...
      const populateValueStub = sinon.stub(serverless.variables, 'populateValue')
        .callsFake(// eslint-disable-next-line no-template-curly-in-string
...
`;
    ...
    it('should populate symlinks', function () {
      ...
      try {
        ...
        if ((error.code === 'EPERM') && (process.platform === 'win32')) {
          // On Windows creating symlinks requires certain admin OS rights
          this.skip();
        }
        throw error;
      }
  ...
  describe('#getValueFromCf()', () => {
    it('should get variable from CloudFormation', () => {
      ...
      const cfStub = sinon.stub(serverless.getProvider('aws'), 'request').callsFake(
  ...
  describe('#getValueFromS3()', () => {
    ...
    it('should get variable from S3', () => {
      ...
      const s3Stub = sinon.stub(awsProvider, 'request')
