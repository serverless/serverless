...
describe('PluginManager', () => {
  ...
  describe('#updateAutocompleteCacheFile()', () => {
    it('should update autocomplete cache file', () => {
      ...
      expect(writeFileSyncStub.getCall(0).args[0]).to.equal(cacheFilePath);
      expect(writeFileSyncStub.getCall(0).args[1].commands).to.deep.equal(expectedCommands);
      expect(typeof writeFileSyncStub.getCall(0).args[1].validationHash).to.equal('string');
