...
describe('PluginManager', () => {
  ...
  describe('#getLocalPluginsPaths()', () => {
    it('should return empty array without any plugins', () => {
      const servicePlugins = {};
      expect(pluginManager.getLocalPluginsPaths(servicePlugins)).to.deep.equal([]);
    });

    it('should return path of all plugins with relative paths', () => {
      const servicePlugins = [
        './sub/directory/Plugin1',
        './sub/other/directory/Plugin2',
        'Plugin3',
      ];
      expect(pluginManager.getLocalPluginsPaths(servicePlugins)).to.deep.equal([
        './sub/directory/Plugin1',
    ...
    it('should return path of all plugins with relative paths when localPath override is provided', () => {
      const servicePlugins = {
        localPath: './myPluginDirectory',
        modules: ['./sub/directory/Plugin1', './sub/other/directory/Plugin2', 'Plugin3'],
      };
      expect(pluginManager.getLocalPluginsPaths(servicePlugins)).to.deep.equal([
        './myPluginDirectory',
        './sub/directory/Plugin1',
