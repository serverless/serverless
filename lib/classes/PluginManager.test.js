...
describe('PluginManager', () => {
  ...
  describe('#validateServerlessConfigDependency()', () => {
    ...
    beforeEach(() => {
      ...
      serverless = new Serverless();
      pluginManager = new PluginManager(serverless);
      pluginManager.serverless.config = { servicePath: 'my-service' };
    });
    ...
    it('should continue loading if the configDependent property is absent', () => {
      ...
      return expect(pluginManager.validateServerlessConfigDependency(foo)).to.be.fulfilled;
    });

    it('should continue loading if the configDependent property is provided with a false value', () => {
      ...
      return expect(pluginManager.validateServerlessConfigDependency(foo)).to.be.fillfilled;
    });

    it('should continue loading if the configDependent property is provided with a true value, and serverless configuration is found', () => {
      getServerlessConfigFileStub.resolves({ service: 'my-service' });
      ...
      return expect(pluginManager.validateServerlessConfigDependency(foo)).to.be.fulfilled.then(() => {
    ...
    it('should throw an error if the property is provided with a true value and no serverless configuration is found', () => {
      getServerlessConfigFileStub.resolves('');
      ...
      return expect(pluginManager.validateServerlessConfigDependency(foo)).to.be.rejected.then(() => {
        expect(getServerlessConfigFileStub).to.have.been.calledOnce;
        expect(getServerlessConfigFileStub).to.have.been.calledWithExactly(process.cwd());
      })
    });
