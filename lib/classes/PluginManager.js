...
class PluginManager {
  ...
  getCommand(commandsArray, allowEntryPoints) {
    ...
    return _.reduce(commandOrAlias, (current, name, index) => {
      ...
      this.getCommandSuggestion(commandName);
  ...
  getCommandSuggestion(inputCommand) {
    let suggestion;
    return this.getCollectCommandWord(this.serverless.cli.loadedCommands)
  ...
  getCollectCommandWord(commandObject, commandWordsArray) {
    ...
    _.forEach(commandObject, (commandChildObject, commandChildName) => {
      ...
      if (commandChildObject.commands) {
        return this.getCollectCommandWord(commandChildObject.commands, wordsArray);
      }
