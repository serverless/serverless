...
class ConfigSchemaHandler {
  ...
  validateConfig(userConfig) {
    ...
    // console.log('userConfig', require('util').inspect(userConfig, false, null, true));
    // console.log('=====');
    // console.log('schema', require('util').inspect(this.schema, false, null, true));
    ...
    if (
      ...
      this.schema.properties.provider.properties.name === undefined
    ) {
    ...
    validate(userConfig);
    if (validate.errors) {
      // console.log('ajv errors', require('util').inspect(validate.errors, false, null, true));
      ...
      switch (this.serverless.service.configValidationMode) {
        ...
        default:
          throw new this.serverless.classes.Error(
            `${ERROR_PREFIX} .configValidationMode should be equal to one of the allowed values 'error' or 'warn'`
          );
      }
    }
  }
