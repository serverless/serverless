...
class CLI {
  ...
  generateMainHelp() {
    this.consoleLog('');
    this.consoleLog(chalk.yellow('The Serverless Framework - https://serverless.com'));
    this.consoleLog('');

    this.consoleLog(chalk.yellow('Version:'));
    this.consoleLog(version);
    this.consoleLog('');

    this.consoleLog(chalk.yellow('Commands:'));
    ...
    this.consoleLog(chalk.yellow('Plugins:'));
