...
const serviceIndependentCommands = new Set(['config credentials']);
...
class CLI {
  ...
  isServiceIndependentRequest(processedInput) {
    return serviceIndependentCommands.has(processedInput.commands.join(' '));
  }
