...
const sdkVersion = require('@serverless/platform-sdk/package.json').version;
...
class CLI {
  ...
  getVersionNumber() {
    this.consoleLog(`${version} (Enterprise Plugin: ${enterpriseVersion}, Platform SDK: ${sdkVersion})`);
  }
