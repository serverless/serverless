...
class SerializerFileSystem {
  ...
  deserializeProject(project) {
    ...
    return SUtils.readFile(path.join(this._projectPath, 's-project.json'))
      ...
      .then(function () {
        ...
        let variableFiles = fs.readdirSync(_this.getRootPath('_meta', 'variables'));
  ...
  deserializeTemplates(templates) {
    ...
    return BbPromise.try(function() {
        ...
        // Set Data
        templates.fromObject(SUtils.readFileSync(templates.getRootPath()));
      })
       .then(function() {

         let parentDir = path.dirname(templates.getRootPath());
  ...
  serializeTemplates(templates) {
    ...
    return BbPromise.try(function() {
        ...
        return SUtils.writeFile(templates.getRootPath(),
