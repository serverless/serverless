    ...
    deserializeProject(project) {
        ...
        return BbPromise.try(function () {
            ...
            .then(function() {
                ...
                // TODO: Load all resources-cf files in project here.
                // Save resources-master resourcesmodules separately
                // Investigate a ResourcesModule class
                            ...
                            let scanFn = function(parentDir, sPathBase, level){
                                ...
                                return BbPromise.resolve(fs.readdirSync(parentDir))
                                    .each(function(sf) {
                                        ...
                                        let filePath = path.join(fPath, 's-resources-cf.json');
    ...
    deserializeComponent(component) {
        ...
        return BbPromise.try(function() {
            ...
            .then(function() {
                ...
                //TODO: Save for other s-templates.json files in subfolders
    ...
    serializeComponent(component, options) {
        ...
        return new BbPromise.try(function () {
            ...
            .then(function () {
                ...
                // Save Templates
                if (options && options.deep) {
                    serialize.push(component.getTemplates().save());
                }
