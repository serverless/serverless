  ...
  deserializeProject(project) {
    ...
    return BbPromise.try(function () {
      ...
      .then(function () {
        ...
        if (_this._S.dirExistsSync(variablesRootPath)) {
  ...
  deserializeFunction(func) {
    ...
    return BbPromise.try(function() {
      ...
      .then(function() {
        ...
        if (fse.ensureFileSync(path.join(func._config.filePath, 's-templates.json'))) {
          template = new this._S.classes.Templates(_this._S, { filePath: path.join(func._config.filePath, 's-templates.json') });
        } else {
          template = new this._S.classes.Templates(_this._S);
        }
