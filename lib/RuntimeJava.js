...
module.exports = function(S) {
  ...
  class RuntimeNode extends S.classes.Runtime {
    ...
    scaffold(func) {
      const handlerPath = path.join(S.getServerlessPath(), 'templates', 'java/Handler.java');
      
      console.log(func.getRootPath('handler.js'));
      console.log("srcPath: " + this.srcPath(func));
    ...
    srcPath(func) {
      ...
      var src = project.getRootPath('src/main/java');
      return path.join(src, func.getName() + ".java");
    }
