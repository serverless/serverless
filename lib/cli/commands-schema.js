...
commands.set('dev', {
  groupName: 'main',
  usage: 'Runs in dev mode',
  options: {
    stage: {
      usage: 'The stage where you want to start your development session.',
      type: 'string',
    },
    region: {
      usage: 'The region where you want to start your development session.',
      type: 'string',
    },
    detailed: {
