...
for (const [name, schema] of commands) {
  ...
  if (name) {
    ...
    schema.options.version = { usage: 'Show version info', type: 'boolean' };
  } else {
    schema.options['help-interactive'] = { usage: 'Show this message', type: 'boolean' };
    schema.options.help = { usage: 'Show general help info', shortcut: 'h', type: 'boolean' };
    schema.options.version = { usage: 'Show version info', shortcut: 'v', type: 'boolean' };
  }
}
