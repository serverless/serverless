...
commands.set('dev', {
  usage: 'Launch a Serverless Console Dev Mode Session directly in your terminal.',
  options: {
    function: {
      usage: 'Specify a specific function you would like to run dev mode on',
      shortcut: 'f',
    },
    org: {
      usage: 'Specify the serverless console organization your aws account is associated with',
      shortcut: 'o',
    },
  },
  lifecycleEvents: ['dev'],
