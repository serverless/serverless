...
const { resolveInitialContext } = require('./../interactive-setup/utils');
const { awsRequest } = require('./../interactive-setup/utils');

const steps = {
  consoleLogin: require('./../interactive-setup/console-login'),
  consoleResolveOrg: require('./../interactive-setup/console-resolve-org'),
  consoleSetupIamRole: require('./../interactive-setup/console-setup-iam-role'),
