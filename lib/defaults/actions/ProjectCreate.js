...
class ProjectCreate extends JawsPlugin {
  ...
  _createJawsBucket() {
    ...
    // Even though we're not creating the stack yet, we should output This
    // message now cause this is our first encouter with AWS, which creates
    // a nasty pause for our users - Eslam
