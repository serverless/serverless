...
class ProjectCreate extends JawsPlugin {
  ...
  _prepareProjectData() {
    ...
    // Set JAWS Bucket
    _this._projectBucket = JawsUtils.generateJawsBucketName(_this.evt.region, _this.evt.domain);
  ...
  _createProjectBucket() {
    let _this = this;
    JawsCLI.log('Creating a project bucket on S3: ' + _this._projectBucket + '...');
