...
class EndpointProvisionApiGateway extends JawsPlugin {
  ...
  _findOrCreateApi() {
    ...
    if (_this.evt.currentRegion.restApiId) {

      let params = {
        restApiId: _this.evt.currentRegion.restApiId /* required */
      };
      ...
      return _this.ApiGateway.getRestApiPromised(params)
          .then(function(response) {
            ...
            _this.evt.currentRegion.restApiId = response.id;
            JawsCli.log(
                '"'
                + _this.evt.stage + ' - '
                + _this.evt.currentRegion.region
  ...
  _createDeployment() {
    ...
    let params = {
      restApiId:            _this.evt.currentRegion.restApiId, /* required */
      stageName:            _this.evt.stage, /* required */
      ...
      stageDescription: _this.evt.stage,
