...
usage: jaws env get`,
  ...
  _promptStage(){
    ...
    return JawsCLI.select('Which stage are you getting the env var from: ', choices, false)
  ...
  _getEnvVar(){
    ...
    return awsMisc.getEnvFiles(_this.Jaws, _this.evt.region, _this.evt.stage)
      .then(envMapsByRegion => {
        ...
        JawsCLI.log(`Values for ${_this.evt.key} in stage ${_this.evt.stage} by region:`);
