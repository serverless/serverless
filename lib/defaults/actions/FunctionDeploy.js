  ...
  _deployRegions() {
    ...
    return BbPromise.try(function() {
        ...
        .each(function(region) {
          ...
          _this.evt.currentRegion = JawsUtils.getProjRegionConfigForStage(_this.Jaws._projectJson, _this.evt.stage, region);
          ...
          switch(_this.evt.type) {
            ...
            case "endpoint":
              ...
              return BbPromise.try(function() {
                    return _this.Jaws.actions.endpointPackageApiGateway(_this.evt.functions)
                  })
                  .bind(_this)
