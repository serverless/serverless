...
usage: jaws module postinstall <pkgMgr> <moduleName>`,
    ...
    postInstall(evt) {
      ...
      return _this._JAWS.validateProject()
        ...
        .then(function() {
          return JawsUtils.findAllEnvletsForAwsm(_this._JAWS._projectRootPath, _this.evt.moduleName);
        })
    ...
    _installFiles() {
      ...
      let srcAwsmPath     = path.join(_this._JAWS._projectRootPath, pkgMgrDir, _this.evt.moduleName, 'awsm'),
          srcAwsmJsonPath = path.join(_this._JAWS._projectRootPath, pkgMgrDir, _this.evt.moduleName, 'awsm.json'),
