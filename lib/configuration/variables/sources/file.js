      ...
      switch (path.extname(filePath)) {
        ...
        case '.cjs': {
          ...
          try {
            ...
            // for some reason, the CI is throwing SyntaxError instead of ERR_REQUIRE_ESM
            if (error.code === 'ERR_REQUIRE_ESM' || error instanceof SyntaxError) {
              try {
                // in Windows you must convert to URL
                result = await import(pathToFileURL(filePath).toString());
