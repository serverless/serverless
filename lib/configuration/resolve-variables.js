...
import resolveVariables from './variables/resolve.js';
import resolveVariablesMeta from './variables/resolve-meta.js';
import isPropertyResolved from './variables/is-property-resolved.js';
import serverlessVariablesSourceEnv from './variables/sources/env.js';
import serverlessVariablesSourceFile from './variables/sources/file.js';
import serverlessVariablesSourceOpt from './variables/sources/opt.js';
import serverlessVariablesSourceSelf from './variables/sources/self.js';
import serverlessVariablesSourceStrToBool from './variables/sources/str-to-bool.js';
import serverlessVariablesSourceSls from './variables/sources/sls.js';
import serverlessVariablesSourceParams from './variables/sources/param.js';
import serverlessVariablesSourceAwsCf from './variables/sources/aws-cf.js';
import serverlessVariablesSourceAwsS3 from './variables/sources/aws-s3.js';
import serverlessVariablesSourceAwsSsm from './variables/sources/aws-ssm.js';
import serverlessVariablesSourceAws from './variables/sources/aws.js';
import resolveExternalPluginSources from './variables/sources/resolve-external-plugin-sources.js';
 ...
 */
export const resolveServerlessVariablesPhaseOne = async ({ service, servicePath, options }) => {
 ...
 */
export const resolveServerlessVariablesPhaseTwo = async ({ service, servicePath, options }) => {
  const sourcesToResolveFrom = ['file', 'self', 'strToBool', 'opt', 'env'];
 ...
 */
export const resolveServerlessVariablesPhaseThree = async ({
  service,
  servicePath,
  options,
 ...
 */
export const resolveServerlessVariablesPhaseFour = async ({
  service,
  servicePath,
  options,
  serverlessFrameworkInstance,
