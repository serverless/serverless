      ...
      properties: {
        'Fn::ImportValue': {
          oneOf: [
            ...
            // Ideally, using as well $ref for cfJoin, cfSub, but ajv does not support circular reference schema
            { type: 'object' },
            { $ref: '#/definitions/cfRef' },
          ],
        },
      },
      additionalProperties: false,
          ...
          items: [
            { type: 'string', minLength: 1 },
            {
              ...
              items: {
                oneOf: [
                  { type: 'string', minLength: 1 },
                  // Ideally, using as well $ref for cfJoin but ajv does not support circular reference schema
                  { type: 'object' },
                  { $ref: '#/definitions/cfGetAtt' },
                  { $ref: '#/definitions/cfImport' },
                  { $ref: '#/definitions/cfSub' },
                  { $ref: '#/definitions/cfRef' },
                ],
              },
            },
