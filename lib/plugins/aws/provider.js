...
class AwsProvider {
  ...
  getRuntimeManagementSourceValue() {
    const values = this.getValues(this, [
      ['serverless', 'service', 'provider', 'runtimeManagement'],
    ]);
    return this.firstValue(values);
  }

  getRuntimeManagement(runtimeManagement) {
    const defaultRuntimeManagement = 'auto';
    const runtimeManagementSourceValue = this.getRuntimeManagementSourceValue();
    return runtimeManagement || runtimeManagementSourceValue.value || defaultRuntimeManagement;
  }
