...
class AwsProvider {
  ...
  resolveFunctionRuntimeManagement(functionRuntimeManagement) {
    const resolveRuntimeManagement = (input) => {
    ...
    const defaultRuntimeManagement = {
      mode: 'auto',
    };
    const resolvedFunctionRuntimeManagement = resolveRuntimeManagement(functionRuntimeManagement);
    const resolvedProviderRuntimeManagement = resolveRuntimeManagement(
      this.serverless.service.provider.runtimeManagement
    );
    return {
      ...defaultRuntimeManagement,
      ...resolvedProviderRuntimeManagement,
      ...resolvedFunctionRuntimeManagement,
    };
  }
