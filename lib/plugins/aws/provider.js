...
import awsSdkMetadataService from 'aws-sdk/lib/metadata_service.js';
...
class AwsProvider {
  constructor(serverless, options) {
    ...
    // Patching AWS SDK's Metadata Service
    const { prototype: metadataServicePrototype } = awsSdkMetadataService;
