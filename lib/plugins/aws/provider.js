...
class AwsProvider {
  ...
  resolveRuntimeManagement(input) {
  ...
  resolveFunctionRuntimeManagement(functionRuntimeManagement) {
    const resolvedFunctionRuntimeManagement =
      this.resolveRuntimeManagement(functionRuntimeManagement);
    const resolvedProviderRuntimeManagement = this.resolveRuntimeManagement(
      this.serverless.service.provider.runtimeManagement
    );
    return { ...resolvedProviderRuntimeManagement, ...resolvedFunctionRuntimeManagement };
  }
