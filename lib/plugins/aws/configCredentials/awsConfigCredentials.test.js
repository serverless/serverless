...
describe('AwsConfigCredentials', () => {
  ...
  beforeEach(() => {
    ...
    sinon.stub(serverless.cli, 'log'); // Silence the unneeded noise output
  });
  ...
  describe('#configureCredentials()', () => {
    ...
    it('should throw an error if the home dir is not found', () => {
      sinon.stub(os, 'homedir').returns(null);

      expect(() => awsConfigCredentials.configureCredentials())
        .to.throw(ServerlessError, 'home directory');
    });
