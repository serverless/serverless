  ...
  describe('#constructor()', () => {
    ...
    describe('"package:compileVpc" promise chain', () => {
      it('should run the promise chain in order', () => {
        awsCompileVpc.hooks['package:compileVpc']();
        ...
        expect(compileVpcGatewayAttachmentStub.calledAfter(compileInternetGatewayStub)).to.be.equal(
          true
        );
        ...
        expect(compileSubnetRouteTableAssociationsStub.calledAfter(compileRoutesStub)).to.be.equal(
          true
        );
        expect(
        ...
        expect(compileCloudFormationOutputsStub.calledAfter(updateFunctionConfigsStub)).to.be.equal(
          true
        );
