          ...
          _.forOwn(properties, value => {
            ...
            _.forOwn(value, potentialLayerObject => {
              ...
              if (_.has(potentialLayerObject, "Ref")) {
                const layerProperties = cfTemplate.Resources[potentialLayerObject.Ref]
                additionalLayerProperties.push(layerProperties)
              }
            })
          })

          const propertiesWithLayerUpdates = _.concat(properties, additionalLayerProperties)

          _.forOwn(propertiesWithLayerUpdates, value => {
            if (_.isObject(value)) {
