...
class AwsCompileFunctions {
  ...
  compileFunction(functionName) {
    return BbPromise.try(() => {
      ...
      const FunctionNamelogGroupsPrefix = this.provider.naming.getLogGroupName(functionObject.name);
      ...
      _.merge(functionObject.iamConfig.policyStatements, logStatements);
      ...
      if ('vpc' in functionObject) {
        functionObject.iamConfig.managedPolicies = functionObject.iamConfig.managedPolicies.concat([
          vpcManagedPolicy,
        ]);
      }
