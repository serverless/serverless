...
describe('AwsCompileFunctions #2', () => {
  describe('Asynchronous Invocations', () => {
    ...
    describe('adding log group policy statements to functions iamConfig objects', async () => {
      ...
      it('should add log statements for case when there are only canonically named functions', async () => {
        ...
        serverless.service.getAllFunctions().forEach(functionName => {
          const statements = serverless.service.getFunction(functionName).iamConfig
            .policyStatements;
