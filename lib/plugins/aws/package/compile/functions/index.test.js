...
describe('lib/plugins/aws/package/compile/functions/index.test.js', () => {
  describe('Package artifacts', () => {
    describe.skip('TODO: Referencing local file', () => {
      // Note: After addressing remove also:
      // https://github.com/serverless/serverless/blob/d8527d8b57e7e5f0b94ba704d9f53adb34298d99/lib/plugins/aws/package/compile/functions/index.test.js#L133-L146
      before(async () => {
        await runServerless({
          fixture: 'packageArtifact',
          configExt: {
            package: { artifact: 'service.zip' },
            functions: {
              foo: { package: { individually: true, artifact: 'function.zip' } },
              other: { package: { individually: true } },
            },
          },
        });
      });

      it('should support `package.artifact`, referencing local file', async () => {
        await runServerless({ fixture: 'packageArtifact', configExt: {} });
        // Replacement for:
        ...
        //
        // Same as above just test locally hosted artifact
      });
      it('should ignore `package.artifact` when packaging individually', () => {
        // Replacement for
      ...
      it('should support `functions[].package.artifact, referencing local file', () => {
        // Replacement for
    ...
    describe.skip('TODO: Referencing S3 bucket', () => {
      before(async () => {
        await runServerless({
          fixture: 'packageArtifact',
          configExt: {
