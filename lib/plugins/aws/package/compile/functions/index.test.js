...
describe('AwsCompileFunctions #2', () => {
  ...
  describe('when using fileSystemConfigs', () => {
    ...
    it('should have no effect when empty fileSystemConfigs provided', () => {
      runServerless({
        ...
        expect(functionConfig).to.not.have.property('FileSystemConfigs');
      });
    });

    describe('when default IamRoleLambdaExecution is used', () => {
    ...
    describe('when default IamRoleLambdaExecution is not used', () => {
      it('should not update the role', () => {
        const arn =
          'arn:aws:elasticfilesystem:region:111111111111:access-point/fsap-a1a1a1a1a1a1a1a1a';
        const localMountPath = '/mnt/path';
        ...
        return fixtures
          ...
          .then(fixturePath =>
            runServerless({
              ...
              expect(cfResources.IamRoleLambdaExecution).to.be.undefined;
            })
          );
      });
    });
