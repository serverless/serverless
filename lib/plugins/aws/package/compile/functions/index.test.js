...
describe('AwsCompileFunctions #2', () => {
  ...
  describe('IamConfig object tests', async () => {
    ...
    before(async () => {
      ({ serverless: sls, awsNaming: naming } = await runServerless({
        fixture: 'function',
        configExt: {
          functions: {
    ...
    it('Should create iamConfig object', () => {
      sls.service.getAllFunctions().forEach(functionName => {
        const functionObject = sls.service.getFunction(functionName);
    ...
    it('should add log policies to iamConfig object', () => {
      ...
      sls.service.getAllFunctions().forEach(functionName => {
        ...
        const FunctionNamelogGroupsPrefix = naming.getLogGroupName(resolvedFunctionName);
