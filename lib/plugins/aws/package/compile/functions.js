    ...
    this.hooks = {
      'initialize': () => {
        ...
        if (
          ...
          this.serverless._logDeprecation(
            'DEFAULT_NODEJS12X_RUNTIME_DEPRECATED',
            'The default runtime "nodejs12.x" is deprecated and will be ' +
              'changed to "nodejs14.x" in the next major release (3.0.0). ' +
              'To avoid seeing this message configure your runtime ' +
              'explicitly to "nodejs14.x".'
          );
        }
      },
