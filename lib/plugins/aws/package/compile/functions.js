...
class AwsCompileFunctions {
  ...
  async compileFunction(functionName) {
    ...
    if (functionObject.handler) {
      ...
      const posixArtifactFilePath = artifactFilePathWithoutPathRoot
        .split(path.sep)
        .join(path.posix.sep);

      functionResource.Properties.Code.S3Key = `${this.serverless.service.package.artifactDirectoryName}/${posixArtifactFilePath}`;
