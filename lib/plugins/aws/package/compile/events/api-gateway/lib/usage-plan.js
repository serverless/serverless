...
function createUsagePlanResource(that, name) {
  ...
  const usagePlan = _get(that.serverless.service.provider.apiGateway, 'usagePlan');
...
module.exports = {
  compileUsagePlan() {
    const apiKeys = _get(this.serverless.service.provider.apiGateway, 'apiKeys');
    const usagePlan = _get(this.serverless.service.provider.apiGateway, 'usagePlan');
