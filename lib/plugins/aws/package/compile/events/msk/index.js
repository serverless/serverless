      ...
      properties: {
        ...
        SourceAccessConfigurations: {
          ...
          items: {
            ...
            properties: {
              Type: {
                enum: ['SASL_SCRAM_512_AUTH', 'CLIENT_CERTIFICATE_TLS_AUTH'],
              },
              URI: { $ref: '#/definitions/awsArnString' },
            },
    ...
    this.serverless.service.getAllFunctions().forEach((functionName) => {
      ...
      functionObj.events.forEach((event) => {
        if (event.msk) {
          ...
          const SourceAccessConfigurations = event.msk.SourceAccessConfigurations;
          ...
          if (SourceAccessConfigurations != null) {
            mskResource.Properties.SourceAccessConfigurations = SourceAccessConfigurations;
          }
