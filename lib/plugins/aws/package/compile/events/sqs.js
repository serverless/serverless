        ...
        { $ref: '#/definitions/awsArnString' },
        {
          ...
          properties: {
            ...
            scalingConfig: {
              type: 'object',
              properties: {
                maximumConcurrency: { type: 'integer', minimum: 2, maximum: 2000 },
              },
              additionalProperties: false,
              required: ['maximumConcurrency'],
            },
      ...
      if (functionObj.events) {
        ...
        functionObj.events.forEach((event) => {
          if (event.sqs) {
            ...
            if (event.sqs.scalingConfig) {
              sqsTemplate.Properties.ScalingConfig = {
                MaximumConcurrency: event.sqs.scalingConfig.maximumConcurrency,
              };
            }
