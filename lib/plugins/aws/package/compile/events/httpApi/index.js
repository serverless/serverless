  ...
  compileStage() {
    ...
    const properties = {
      ...
      DefaultRouteSettings: {
        ...
        ThrottlingBurstLimit: this.config.throttle.burstLimit,
        ThrottlingRateLimit: this.config.throttle.rateLimit,
      },
    };
  ...
  memoizeeMethods({
    resolveConfiguration: d(function() {
      ...
      this.config = {
        ...
        throttle: {
          burstLimit: (userConfig.throttle && userConfig.throttle.burstLimit) || -1,
          rateLimit: (userConfig.throttle && userConfig.throttle.rateLimit) || -1,
        },
      };
      let cors = null;
