...
describe('#validate()', () => {
  ...
  describe('#validateAlbAuth()', () => {
    ...
    it('returns valid authorizer when valid object provided with onUnauthenticatedRequest set to deny', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
        onUnauthenticatedRequest: 'deny',
    ...
    it('returns valid authorizer when valid object provided with onUnauthenticatedRequest set to allow', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
        onUnauthenticatedRequest: 'allow',
    ...
    it('returns valid authorizer when valid object provided with onUnauthenticatedRequest set to authenticate', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
    ...
    it('returns valid authorizer when valid object provided with onUnauthenticatedRequest set to allow and disabled allowUnauthenticated', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
        onUnauthenticatedRequest: 'allow',
    ...
    it('returns valid authorizer when valid object provided with onUnauthenticatedRequest set to deny and allowUnauthenticated', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
        onUnauthenticatedRequest: 'deny',
    ...
    it('throws if onUnauthenticatedRequest value is not in deny/allow/authenticate', () => {
      const auth = {
        type: 'oidc',
        clientSecret: 'i-am-secret',
        onUnauthenticatedRequest: 'invalid',
      };
      expect(() => awsCompileAlbEvents.validateAlbAuth(auth, 'authName')).to.throw();
    });
  });
});
