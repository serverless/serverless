...
describe('#compileListenerRules()', () => {
  ...
  it('should create ELB listener rule resources', () => {
      ...
      events: [
        ...
        },
        {
          ...
          authenticateCognito: {
            ...
            scope: 'name age',
            sessionCookieName: 'my-cookieName',
    ...
    expect(resources.FourthAlbListenerRule4).to.deep.equal({
      Type: 'AWS::ElasticLoadBalancingV2::ListenerRule',
      Properties: {
        Actions: [
          {
          ...
          {
            TargetGroupArn: {
              Ref: 'FourthAlbTargetGroup50dc6c495c0c9188',
            },
            Order: 2,
            Type: 'forward',
          },
