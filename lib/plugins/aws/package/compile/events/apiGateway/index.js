...
class AwsCompileApigEvents {
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      'after:deploy:deploy': () => {
        const updateStage = require('./lib/hack/updateStage').updateStage; // eslint-disable-line
      ...
      'before:remove:remove': () => {
        ...
        const disassociateUsagePlan = require('./lib/hack/disassociateUsagePlan').disassociateUsagePlan; // eslint-disable-line
