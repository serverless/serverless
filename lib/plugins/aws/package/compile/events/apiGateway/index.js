...
const lambdaProxyIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: caseInsensitive('lambda_proxy'),
  },
...
const mockIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: caseInsensitive('mock'),
  },
  required: ['integration'],
});
...
const awsIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: {
      oneOf: ['aws', 'aws_proxy'].map(caseInsensitive),
    },
  },
  required: ['integration'],
});
...
const httpIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: {
      oneOf: ['http', 'http_proxy'].map(caseInsensitive),
    },
    request: {
      required: ['uri'],
    },
...
const lambdaIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: caseInsensitive('lambda'),
    authorizer: {
      properties: {
...
const cognitoIntegrationSchema = _.merge({}, baseIntegrationSchema, {
  properties: {
    integration: caseInsensitive('cognito_user_pools'),
    authorizer: {
      required: ['name'],
    },
  },
