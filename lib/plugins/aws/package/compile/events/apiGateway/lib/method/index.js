...
const resolveConditionForFunction = require('../../../../../../utils/resolveConditionForFunction');
  ...
  compileMethods() {
    ...
    this.validated.events.forEach(event => {
      ...
      if (functionObject.condition) {
        template.Condition = functionObject.condition;
      }
      ...
      if (resolveConditionForFunction(functionObject, this.serverless.service.resources)) {
