...
describe('#compileApiKeys()', () => {
  ...
  it('should support api key notation', () => {
    awsCompileApigEvents.serverless.service.provider.apiKeys = [
      ...
      { name: '9876543211', value: 'valueForKey9876543211', customerId: 'customerid98765' },
    ];

    return awsCompileApigEvents.compileApiKeys().then(() => {
      const expectedApiKeys = [
        { name: '1234567890', value: undefined, description: undefined, customerId: undefined },
        { name: '2345678901', value: undefined, description: undefined, customerId: undefined },
        { name: undefined, value: 'valueForKeyWithoutName', description: 'Api key description', customerId: undefined },
        { name: '3456789012', value: 'valueForKey3456789012', description: undefined, customerId: undefined },
        { name: '9876543211', value: 'valueForKey9876543211', description: undefined, customerId: 'customerid98765' },
      ];
