...
module.exports = {
  compileStage() {
    ...
    const logsIamRole = provider.logs && provider.logs.restApiIamRole;
    ...
    if (logs || TracingEnabled || Tags.length > 0) {
      ...
      if (logs) {
        ...
        _.merge(cfTemplate.Resources, {
          ...
          [logsRoleLogicalId]: logsIamRole ? getIamRoleResource(provider.logs.restApiIamRole) : getIamRoleResource(service, stage),
