...
describe('UsagePlan', () => {
  ...
  it('Should have values for throttle', () => {
    ...
    return runServerless({
      ...
      expect(cfResources.ApiGatewayUsagePlan.Properties.Throttle).to.not.be.undefined;
  ...
  it('Should have values for quota', () => {
    ...
    return runServerless({
      ...
      expect(cfResources.ApiGatewayUsagePlan.Properties.Quota).to.not.be.undefined;
