...
const awsArnRegularExpressions = require('../../../../../utils/arnRegularExpressions');
module.exports = {
  ...
  compilePermissions() {
    this.permissionMapping.forEach((singlePermissionMapping) => {
      ...
      if (singlePermissionMapping.event.http.authorizer &&
        ...
        if (typeof authorizer.arn === 'string' && authorizer.arn.match(awsArnRegularExpressions.cognitoIdpArnExpr)) {
          return;
        }
