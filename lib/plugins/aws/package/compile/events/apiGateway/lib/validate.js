...
module.exports = {
  validate() {
    ...
    this.validateRestApiRootResourceId();
  ...
  validateRestApiRootResourceId() {
    ...
    if (apiGateway && apiGateway.restApiId && !apiGateway.restApiRootResourceId) {
      throw new ServerlessError(
        "Configuration warning at 'provider.apiGateway': should have required property 'restApiRootResourceId'",
        'RESTAPIROOTRESOURCEID_PROPERTY_MISSING'
      );
    }
  },
};
