...
describe('#compileMethods()', () => {
  ...
  it('should have request validators/models defined when they are set', () => {
    ...
    return awsCompileApigEvents.compileMethods().then(() => {
      expect(
        ...
        Properties: {
          Name: 'UsersCreateModelValidator',
      ...
      expect(
        ...
        Properties: {
          Description: 'Validation model for UsersCreateModel',
          Name: 'UsersCreateModel',
          RestApiId: { Ref: 'ApiGatewayRestApi' },
  ...
  it('should support inline model configuration and default name and description when absent', () => {
    awsCompileApigEvents.validated.events = [
      {
        functionName: 'First',
        http: {
  ...
  it('should support schema references in provider', () => {
    awsCompileApigEvents.validated.events = [
      {
        functionName: 'First',
        http: {
          ...
          request: {
            schema: {
              'application/json': 'user-create-model',
            },
          },
        },
      },
    ...
    awsCompileApigEvents.serverless.service.provider.apiGateway = {
      models: {
        'user-create-model': {
          modelLogicalId: 'UserCreateModel',
          validatorLogicalId: 'UserCreateModelValidator',
        },
      },
    };
    return awsCompileApigEvents.compileMethods().then(() => {
      ...
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources
          .ApiGatewayMethodUsersCreatePost.Properties.RequestValidatorId
      ).to.deep.equal({ Ref: 'UserCreateModelValidator' });
    });
  });
