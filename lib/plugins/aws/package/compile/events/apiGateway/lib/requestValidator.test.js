    ...
    it('should create a new model from a schema only', () =>
      fixtures.extend('requestSchema', {}).then(fixturePath =>
        runServerless({
          ...
          const validatorLogicalId = naming.getEndpointValidatorLogicalId('Test2', 'get');
    ...
    it('should create a new model from a schma with name and description', () =>
      fixtures.extend('requestSchema', {}).then(fixturePath =>
        runServerless({
          ...
          const validatorLogicalId = naming.getEndpointValidatorLogicalId('Test3', 'get');
    ...
    it('should allow multiple schemas to be defined', () =>
      fixtures.extend('requestSchema', {}).then(fixturePath =>
        runServerless({
          ...
          const validatorLogicalId = naming.getEndpointValidatorLogicalId('Test5', 'get');
    ...
    it('should support existing request:schema property for regression', () =>
      fixtures.extend('requestSchema', {}).then(fixturePath =>
        runServerless({
          ...
          const validatorLogicalId = naming.getEndpointValidatorLogicalId('Test4', 'get');
    ...
    it('should support multiple request:schema property for regression', () =>
      fixtures.extend('requestSchema', {}).then(fixturePath =>
        runServerless({
          ...
          const validatorLogicalId = naming.getEndpointValidatorLogicalId('Test6', 'get');
