...
describe('AwsCompileIoTEvents', () => {
  ...
  describe('#awsCompileIoTEvents()', () => {
    ...
    it('should respect "arn" variable', () => {
      awsCompileIoTEvents.serverless.service.functions = {
        first: {
          events: [
            {
              iot: {
                arn: 'arn:aws:iot:us-east-1:11223344:rule/my-rule',
              },
            },
          ],
        },
      ...
      expect(
        awsCompileIoTEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources
          .FirstLambdaPermissionIotTopicRule1.Properties.SourceArn
      ).to.equal('arn:aws:iot:us-east-1:11223344:rule/my-rule');
    });

    it('should not create IoT Rule when arn variable provided', () => {
      awsCompileIoTEvents.serverless.service.functions = {
        first: {
          events: [
            {
      ...
      ).to.deep.equal(['FirstLambdaPermissionIotTopicRule1']);
    });
