      ...
      if (functionObj.events) {
        functionObj.events.forEach((event) => {
          ...
          if (event.sns.filterPolicy) {
            snsSubscriptionResource.Properties.FilterPolicy = event.sns.filterPolicy;
          }
          ...
          if (event.sns.redrivePolicy) {
            ...
            snsSubscriptionResource.Properties.RedrivePolicy = {
            ...
            cfTemplate.Resources[queuePolicyLogicalId] = {
