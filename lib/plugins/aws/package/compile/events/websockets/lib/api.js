...
module.exports = {
  compileApi() {
    ...
    const RouteSelectionExpression =
      apiGateway.websocketsApiRouteSelectionExpression || '$request.body.action';

    const ApiKeySelectionExpression =
      apiGateway.websocketsApiKeySelectionExpression || '$request.header.x-api-key';
