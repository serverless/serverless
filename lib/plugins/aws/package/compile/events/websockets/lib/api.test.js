...
describe('#compileApi()', () => {
  ...
  it('should set ApiKeySelectionExpression', () => {
    awsCompileWebsocketsEvents.serverless.service.provider.websocketsApiKeySelectionExpression =
      '5ezys3sght';
    ...
    return awsCompileWebsocketsEvents.compileApi().then(() => {
      ...
      expect(resources.WebsocketsApi).to.deep.equal({
        ...
        Properties: {
          Name: 'dev-my-service-websockets',
          RouteSelectionExpression: '$request.body.action',
          ApiKeySelectionExpression: '5ezys3sght',
          Description: 'Serverless Websockets',
          ProtocolType: 'WEBSOCKET',
        },
      });
  ...
  it('should set RouteSelectionExpression', () => {
    awsCompileWebsocketsEvents.serverless.service.provider.websocketsApiRouteSelectionExpression =
      '5ezys3sght';
    ...
    return awsCompileWebsocketsEvents.compileApi().then(() => {
      ...
      expect(resources.WebsocketsApi).to.deep.equal({
        ...
        Properties: {
          Name: 'dev-my-service-websockets',
          RouteSelectionExpression: '5ezys3sght',
          ApiKeySelectionExpression: '$request.header.x-api-key',
          Description: 'Serverless Websockets',
          ProtocolType: 'WEBSOCKET',
        },
