      ...
      anyOf: [
        { $ref: '#/definitions/awsArn' },
        {
          ...
          properties: {
            ...
            maximumBatchingWindow: { type: 'integer', minimum: 0 },
          },
          required: ['arn'],
      ...
      if (functionObj.events) {
        ...
        functionObj.events.forEach(event => {
          if (event.sqs) {
            ...
            const sqsTemplateObject = JSON.parse(sqsTemplate);

            if (typeof event.sqs.maximumBatchingWindow !== 'undefined') {
              sqsTemplateObject.Properties.MaximumBatchingWindowInSeconds =
            ...
            const newSQSObject = {
              [queueLogicalId]: sqsTemplateObject,
            };
