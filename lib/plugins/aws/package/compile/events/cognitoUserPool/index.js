...
class AwsCompileCognitoUserPoolEvents {
  constructor(serverless) {
    ...
    this.hooks = {
      ...
      'aws:package:finalize:mergeCustomProviderResources': this
        .mergeWithCustomResources.bind(this),
    };
  }
  ...
  compileCognitoUserPoolEvents() {
    const { cognitoUserPoolTriggerFunctions, userPools } = this.findUserPoolsAndFunctions();
