      ...
      if (functionObj.events) {
        functionObj.events.forEach((event, idx) => {
          if (event.eventBridge) {
            ...
            const MaximumEventAgeInSeconds = event.eventBridge.MaximumEventAgeInSeconds;
            const MaximumRetryAttempts = event.eventBridge.MaximumRetryAttempts;
            const DeadLetterConfigArn = event.eventBridge.DeadLetterConfigArn;
