      ...
      if (functionObj.events) {
        ...
        if (
          ...
          if (dynamodbStreamStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(dynamodbStreamStatement);
          }
          if (kinesisStreamStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(kinesisStreamStatement);
          }
          if (kinesisStreamWithConsumerStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(kinesisStreamWithConsumerStatement);
          }
          if (kinesisConsumerStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(kinesisConsumerStatement);
          }
          if (onFailureSnsStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(onFailureSnsStatement);
          }
          if (onFailureSqsStatement.Resource.length) {
            functionObj.iamConfig.policyStatements.push(onFailureSqsStatement);
          }
        }
      }
    });
