    ...
    this.hooks = {
      'initialize': () => {
        if (
          ...
          this.serverless.service.provider.stream &&
          ...
          this.serverless._logDeprecation(
            'consumerNamingMode',
            "consumerNamingMode will be removed in v3 and have default value 'serviceSpecific'"
          );
        }
      },
            ...
            if (event.stream.consumer && streamType === 'kinesis') {
              if (event.stream.consumer === true) {
                ...
                if (
                  ...
                  consumerName = this.provider.naming.getServiceSpecificStreamConsumerName(
                    functionName,
                    streamName
                  );
                }
