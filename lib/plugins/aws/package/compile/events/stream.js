      ...
      'initialize': () => {
        if (
          ...
          this.serverless._logDeprecation(
            ...
            'Consumer name for Kinesis streams will be different in v3. The new naming will cause re-deployment which may lead to delay in Kinesis stream data processing.'
          );
        }
      },
