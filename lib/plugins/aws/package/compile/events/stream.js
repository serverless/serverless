      ...
      'initialize': () => {
        if (
          ...
          this.serverless._logDeprecation(
            ...
            'Starting with v3.0.0, generated consumer name for Kinesis streams will use a new naming scheme that will include service and stage to ensure uniqueness across different services and/or stages. In order to hide the deprecation and ensure seamless upgrade, please set `provider.kinesis.consumerNamingMode` property to `serviceSpecific`.'
          );
        }
      },
