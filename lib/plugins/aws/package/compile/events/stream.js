      ...
      anyOf: [
        { $ref: '#/definitions/awsArnString' },
        {
          ...
          properties: {
            ...
            tumblingWindowInSeconds: { type: 'integer', minimum: 1, maximum: 900 },
        ...
        functionObj.events.forEach((event) => {
          if (event.stream) {
            ...
            if (typeof event.stream === 'object') {
              ...
              if (event.stream.tumblingWindowInSeconds) {
                tumblingWindowInSeconds = event.stream.tumblingWindowInSeconds;
              }
            } else {
