        ...
        { $ref: '#/definitions/awsArnString' },
        {
          ...
          properties: {
            ...
            functionResponseTypes: {
              type: 'array',
              items: { enum: ['ReportBatchItemFailures'] },
            },
            destinations: {
              type: 'object',
              properties: {
      ...
      if (functionObj.events) {
        ...
        functionObj.events.forEach((event) => {
          if (event.stream) {
            ...
            if (event.stream.functionResponseTypes != null) {
              streamResource.Properties.FunctionResponseTypes = event.stream.functionResponseTypes;
            }
