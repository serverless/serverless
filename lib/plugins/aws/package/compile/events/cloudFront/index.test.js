...
describe('AwsCompileCloudFrontEvents', () => {
  ...
  describe('#constructor()', () => {
    ...
    it('should set the flag that Stack operations should be async', () =>
      expect(
        awsCompileCloudFrontEvents.serverless.service.provider.asyncStackOperation
      ).to.be.equal(true));

    it('should log an info message if the users wants to remove the stack', () => {
