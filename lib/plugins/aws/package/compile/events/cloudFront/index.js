            ...
            if (event.cloudFront.behavior) {
              if (event.cloudFront.behavior.ForwardedValues) {
                this.serverless._logDeprecation(
                  ...
                  'Starting with next major version, Cloudfront ForwardedValues cache behavior property will be removed. Please use a cache policy or an origin request policy instead of this field.'
                );
              }
