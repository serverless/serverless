...
class AwsCompileCloudFrontEvents {
  constructor(serverless) {
    ...
    // CloudFront operations (deployment and removal) should be run async
    Object.assign(this.serverless.service.provider, { asyncStackOperation: true });
  }

  prepareFunctions() {
    // Lambda@Edge functions need to be versioned,
    // can have a max memory size of 128 and a timeout of 5
