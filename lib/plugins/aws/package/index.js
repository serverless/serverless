...
const generateIamRoleLambdaExecutionTemplate = require('./lib/generateIamRoleLambdaExecutionTemplate');
...
class AwsPackage {
  constructor(serverless, options) {
    ...
    Object.assign(
      ...
      generateIamRoleLambdaExecutionTemplate,
    ...
    this.hooks = {
      ...
      'package:setupProviderConfiguration': () => this.generateIamRoleLambdaExecutionTemplate(),
      ...
      'aws:package:finalize:resolveIamRoles': () => {
