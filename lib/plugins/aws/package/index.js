...
const validateCompiledTemplate = require('./lib/validateCompiledTemplate');
...
class AwsPackage {
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      'after:package:setupProviderConfiguration': () => BbPromise.bind(this)
        .then(this.validateCompiledTemplate),
