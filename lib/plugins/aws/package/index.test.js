  ...
  describe('hooks', () => {
    ...
    beforeEach(() => {
      ...
      generateArtifactDirectoryNameStub = sinon
        ...
        .resolves();
      validateSchemaStub = sinon.stub(awsPackage, 'validateSchema');
    ...
    afterEach(() => {
      ...
      awsPackage.validateSchema.restore();
    ...
    it('should run "package:validateSchema" hook', () =>
      awsPackage.hooks['package:validateSchema']().then(() => {
        expect(validateSchemaStub.calledOnce).to.equal(true);
      }));
