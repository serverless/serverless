  ...
  saveServiceState() {
    ...
    const state = {
      ...
      package: {
        ...
        deploymentDirectoryPrefix: this.serverless.service.package.deploymentDirectoryPrefix,
        timestamp: this.serverless.service.package.timestamp,
        artifactsMap: { ...this.serverless.service.package.artifactsMap },
        artifact,
      },
    };
