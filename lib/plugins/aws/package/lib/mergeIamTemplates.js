...
module.exports = {
  mergeIamTemplates() {
    ...
    this.serverless.service.getAllFunctions().forEach(functionName => {
      ...
      // RAUL: two options:
      //       - leave these push statements as they are
      //       - refactor them so they push to statement provider.iamConfig object
      //         BUT FIRST, you will have to edit the iamConfig object so that it contains
      //         the statements from the CF IAM Template
