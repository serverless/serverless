  ...
  mergeIamTemplates() {
    ...
    this.serverless.service
      ...
      .forEach((functionName) => {
        ...
        const logGroupTags = Object.keys(this.serverless.service.provider.stackTags || {});
        if (logGroupTags.length) {
          newLogGroup[logGroupLogicalId].Properties.Tags = logGroupTags.map((logGroupTagKey) => ({
            Key: logGroupTagKey,
            Value: this.serverless.service.provider.stackTags[logGroupTagKey],
          }));
        }
