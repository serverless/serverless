    ...
    this.serverless.service
      ...
      .forEach((functionName) => {
        ...
        const logDataProtectionPolicy =
          functionObject.logDataProtectionPolicy || this.provider.getLogRetentionInDays();
        if (logDataProtectionPolicy) {
          newLogGroup[logGroupLogicalId].Properties.RetentionInDays = logDataProtectionPolicy;
        }
