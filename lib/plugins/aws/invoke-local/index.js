  ...
  async invokeLocal() {
    ...
    if (['java8', 'java11', 'java17', 'java21'].includes(runtime)) {
      ...
      if (
        ...
        (this.options.functionObj.package && this.options.functionObj.package.individually === true)
      ) {
        artifact = this.options.functionObj.package
          ? this.options.functionObj.package.artifact
          : undefined;
      } else {
        artifact =
