...
class AwsInvokeLocal {
  ...
  async invokeLocal() {
    log.warning(
      'For a better experience, try using "serverless dev" to route events from your live architecture to your local code, allowing you to make quick changes without deployment.'
    );
