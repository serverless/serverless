...
describe('updateStack', () => {
  ...
  beforeEach(() => {
    ...
    awsDeploy.serverless.service.customProviderResources = {};
  ...
  describe('#update()', () => {
    ...
    it('should merge custom provider resources into the services resources section', () => {
      ...
      awsDeploy.serverless.service.customProviderResources.Resources = customProviderResourcesMock;

      return awsDeploy.update().then(() => {
        expect(awsDeploy.serverless.service.resources.Resources.fakeResource1)
          .to.deep.equal(customProviderResourcesMock.fakeResource1);
        expect(awsDeploy.serverless.service.resources.Resources.fakeResource2)
          .to.deep.equal(customProviderResourcesMock.fakeResource2);
      });
    });
