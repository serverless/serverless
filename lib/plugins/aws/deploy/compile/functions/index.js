...
class AwsCompileFunctions {
  ...
  compileFunctions() {
    if (typeof this.serverless.service.provider.iamRoleARN !== 'string') {
      ...
      // set the necessary variables for the IamRoleLambdaExecution
    ...
    this.serverless.service.getAllFunctions().forEach((functionName) => {
      ...
      const newFunctionObject = {
        [naming.getLogicalLambdaName(functionName)]: newFunction,
      };
      ...
      newOutput.Value = { 'Fn::GetAtt': [naming.getLogicalLambdaName(functionName), 'Arn'] };

      const newOutputObject = {
        [naming.getLogicalLambdaArnName(functionName)]: newOutput,
      };
