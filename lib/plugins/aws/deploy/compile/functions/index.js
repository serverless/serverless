  ...
  compileFunctions() {
    ...
    this.serverless.service.getAllFunctions().forEach((functionName) => {
      ...
      if (functionObject.vpc) {
        ...
        if (functionObject.vpc.securityGroupIds) {
          newFunction.Properties.VpcConfig.SecurityGroupIds = functionObject.vpc.securityGroupIds;
        }

        if (functionObject.vpc.subnetIds) {
          newFunction.Properties.VpcConfig.SubnetIds = functionObject.vpc.subnetIds;
        }
      }
