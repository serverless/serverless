  ...
  compileFunctions() {
    ...
    this.serverless.service.getAllFunctions().forEach((functionName) => {
      ...
      if (this.serverless.service.provider.bucketName) {
        const bucketName = this.serverless.service.provider.bucketName;
        newFunction.Properties.Code.S3Bucket = bucketName;
        this.serverless.service.provider.compiledCloudFormationTemplate.Outputs.ServerlessDeploymentBucketName.Value = bucketName;
        delete this.serverless.service.provider.compiledCloudFormationTemplate.Resources.ServerlessDeploymentBucket;
      }
