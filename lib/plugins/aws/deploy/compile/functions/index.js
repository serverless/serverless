...
class AwsCompileFunctions {
  ...
  compileFunction(functionName) {
    ...
    if ('kmsKeyArn' in functionObject) {
      newFunction.Properties.KmsKeyArn = functionObject.kmsKeyArn;
    } else if ('kmsKeyArn' in this.serverless.service.provider) {
      newFunction.Properties.KmsKeyArn = this.serverless.service.provider.kmsKeyArn;
    }
