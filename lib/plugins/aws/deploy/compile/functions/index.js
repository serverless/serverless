...
class AwsCompileFunctions {
  ...
  compileFunction(functionName) {
    ...
    if (typeof this.serverless.service.provider.iamRoleARN === 'string') {
      ...
      newFunction.Properties.Role = { 'Fn::GetAtt': [
        this.provider.naming.getLogicalRoleName(),
        'Arn',
      ] };
    }
    ...
    newOutput.Value = { 'Fn::GetAtt': [
      this.provider.naming.getLogicalLambdaName(functionName),
      'Arn',
    ] };
