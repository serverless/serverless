...
describe('AwsCompileFunctions', () => {
  ...
  describe('#compileFunctions()', () => {
    ...
    it('should use a provider KMS key ARN if specified', () => {
      awsCompileFunctions.serverless.service.functions = {
        func: {
          name: 'new-service-dev-func',
          handler: 'func.function.handler',
      ...
      awsCompileFunctions.serverless.service.provider.kmsKeyArn =
        'arn:aws:kms:us-east-1:1234567890:key/76aa38ca-17b7-4c96-9a89-38df27cbeafe';
    ...
    it('should prefer a function over provider KMS ARN if specified', () => {
      awsCompileFunctions.serverless.service.functions = {
        func: {
          name: 'new-service-dev-func',
          handler: 'func.function.handler',
          kmsKeyArn: 'arn:aws:kms:us-east-1:1234567890:key/from-function-config',
        },
      };

      awsCompileFunctions.serverless.service.provider.kmsKeyArn =
        'arn:aws:kms:us-east-1:1234567890:key/from-provider-config';
