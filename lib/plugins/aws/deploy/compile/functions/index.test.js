...
describe('AwsCompileFunctions', () => {
  ...
  describe('#compileRole()', () => {
    ...
    describe('Errors if unsupported object type is provided', () => {
      [
        {
          name: 'should throw exception for object type { Ref: "Foo" }',
          role: { Ref: 'Foo' },
        },
        {
          name: 'should throw exception for object type Buffer',
          role: new Buffer('Foo'),
        },
        {
          name: 'should throw exception for object type Array',
          role: [1, 2, 3],
        },
        {
          name: 'should throw exception for not an object and not a string',
          role: 3,
        },
        {
          name: 'should throw exception for empty role',
          role: null,
        },
        ...
        it(testCase.name, () => {
          ...
          expect(() =>
            awsCompileFunctions.compileRole(resource, testCase.role)
          ).to.throw(Error, 'Unsupported role provided');
        });
      });
    });
  });
