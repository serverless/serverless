...
describe('AwsCompileFunctions', () => {
  ...
  describe('#compileFunctions()', () => {
    ...
    it('should merge the IamRoleLambda template into the services Resources section', () => {
      ...
      expect(awsCompileFunctions.serverless.service.resources.Resources.IamRoleLambda)
        .to.deep.equal(iamRoleLambdaTemplate.IamRoleLambda);
    });

    it('should merge the IamPolicyLambda template into the services Resources section', () => {
      awsCompileFunctions.compileFunctions();
      ...
      expect(awsCompileFunctions.serverless.service.resources.Resources.IamPolicyLambda.Type)
        .to.equal('AWS::IAM::Policy');
    });

    it('should update the necessary variables for the IamPolicyLambda', () => {
      awsCompileFunctions.compileFunctions();

      expect(awsCompileFunctions.serverless.service.resources.Resources
        .IamPolicyLambda
        .Properties
        .PolicyName
      ).to.equal(
