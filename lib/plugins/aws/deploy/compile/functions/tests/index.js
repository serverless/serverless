  ...
  describe('#compileFunctions()', () => {
    ...
    it('should use service artifact if not individually', () => {
      ...
      const functionResource = awsCompileFunctions.serverless.service.provider
        .compiledCloudFormationTemplate.Resources[naming.getLogicalLambdaName(functionName)];
    ...
    it('should merge the IamRoleLambdaExecution template into the CloudFormation template', () => {
      ...
      IamRoleLambdaExecutionTemplate
        .IamRoleLambdaExecution.Properties.Path = naming.getRolePath();
      IamRoleLambdaExecutionTemplate
        .IamRoleLambdaExecution.Properties.RoleName = naming.getRoleName();
    ...
    it('should add iamRoleARN', () => {
      ...
      expect(awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[naming.getLogicalLambdaName('func')].Properties.Role
    ...
    it('should create a simple function resource', () => {
      ...
      expect(awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
          .Resources[naming.getLogicalLambdaName('func')]
    ...
    it('should include description if specified', () => {
      ...
      expect(
        awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
          .Resources[naming.getLogicalLambdaName('func')].Properties.Description
    ...
    it('should create corresponding function output objects', () => {
      ...
      const expectedOutputs = {
        [naming.getLogicalLambdaArnName('func')]: {
          Description: 'Lambda function info',
          Value: { 'Fn::GetAtt': [naming.getLogicalLambdaName('func'), 'Arn'] },
        },
        [naming.getLogicalLambdaArnName('anotherFunc')]: {
          Description: 'Lambda function info',
          Value: { 'Fn::GetAtt': [naming.getLogicalLambdaName('anotherFunc'), 'Arn'] },
        },
      };
