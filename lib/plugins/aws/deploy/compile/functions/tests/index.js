  ...
  describe('#compileFunctions()', () => {
    ...
    it('should use service artifact if not individually', () => {
      ...
      const functionResource = awsCompileFunctions.serverless.service.provider
        .compiledCloudFormationTemplate.Resources[
          awsCompileFunctions.sdk.naming.getLogicalLambdaName(functionName)
        ];
    ...
    it('should add iamRoleARN', () => {
      ...
      expect(awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileFunctions.sdk.naming.getLogicalLambdaName('func')].Properties.Role
    ...
    it('should create a simple function resource', () => {
      ...
      const compiledFunction = {
        ...
        Properties: {
          Code: {
            ...
            S3Bucket: { Ref: awsCompileFunctions.sdk.naming.getLogicalDeploymentBucketName() },
          },
          FunctionName: 'new-service-dev-func',
          Handler: 'func.function.handler',
          MemorySize: 1024,
          Role: { 'Fn::GetAtt': [awsCompileFunctions.sdk.naming.getLogicalRoleName(), 'Arn'] },
          Runtime: 'nodejs4.3',
          Timeout: 6,
        },
      };
      ...
      expect(awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
          .Resources[awsCompileFunctions.sdk.naming.getLogicalLambdaName('func')]
    ...
    it('should include description if specified', () => {
      ...
      expect(awsCompileFunctions.serverless.service.provider.compiledCloudFormationTemplate
          .Resources[
            awsCompileFunctions.sdk.naming.getLogicalLambdaName('func')
    ...
    it('should create corresponding function output objects', () => {
      ...
      const expectedOutputs = {
        [awsCompileFunctions.sdk.naming.getLogicalLambdaArnName('func')]: {
        ...
        [awsCompileFunctions.sdk.naming.getLogicalLambdaArnName('anotherFunc')]: {
          Description: 'Lambda function info',
          Value: {
            'Fn::GetAtt': [
              awsCompileFunctions.sdk.naming.getLogicalLambdaName('anotherFunc'),
              'Arn',
            ],
          },
        },
