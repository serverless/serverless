...
describe('AwsCompileCloudWatchLogEvents', () => {
  ...
  describe('#compileCloudWatchLogEvents()', () => {
    it('should throw an error if cloudwatch event type is not an object or an string', () => {
    ...
    it('should not create corresponding resources when "cloudwatchLog" property is not given',
    () => {
      awsCompileCloudWatchLogEvents.serverless.service.functions = {
        first: {
          events: [
