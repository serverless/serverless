...
describe('AwsCompileIoTEvents', () => {
  ...
  describe('#awsCompileIoTEvents()', () => {
    ...
    it('should throw an error if the "rule" property is not given', () => {
      awsCompileIoTEvents.serverless.service.functions = {
        first: {
          events: [
            {
    ...
    it('should throw an error if the "rule" property is not an object', () => {
      awsCompileIoTEvents.serverless.service.functions = {
        first: {
          events: [
            {
    ...
    it('should respect enable variable if the "enable" property is not given', () => {
      awsCompileIoTEvents.serverless.service.functions = {
        first: {
          events: [
            {
