        ...
        functionObj.events.forEach(event => {
          if (event.iot) {
            ...
            if (typeof event.iot === 'object') {
              if (!event.iot.rule || typeof event.iot.rule !== 'object') {
                const errorMessage = [
                  `Missing "rule" property for iot event in function ${functionName}`,
              ...
              AwsIotSqlVersion = event.iot.rule.sqlVersion;
              Description = event.iot.rule.description;
              RuleDisabled = !event.iot.rule.enabled;
              Sql = event.iot.rule.sql;
            } else {
              const errorMessage = [
