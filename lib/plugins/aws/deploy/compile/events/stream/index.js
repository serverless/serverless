      ...
      if (functionObj.events) {
        functionObj.events.forEach(event => {
          ...
          if (event.stream) {
            ...
            if (!deprecationMessagePrinted) {
              const warningMessage = [
                'Deprecation Notice: "stream" event source is deprecated and is now',
                ' replaced with "dynamodb" or "kinesis" event sources.',
                ' Please check the docs for more info.',
              ].join('');
              this.serverless.cli.log(warningMessage); // eslint-disable-line no-console
          ...
          if (streamType) {
            ...
            if (typeof event[streamType] === 'object') {
              if (!event[streamType].arn) {
                const errorMessage = [
                  ...
                  ' The correct syntax is: <streamType>: <StreamArn>',
            ...
            // update the PolicyDocument statements if it exists
