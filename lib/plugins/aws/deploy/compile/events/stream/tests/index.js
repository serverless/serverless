...
describe('AwsCompileStreamEvents', () => {
  ...
  describe('#compileStreamEvents()', () => {
    ...
    it('should not add the IAM role statements if using custom role', () => {
      awsCompileStreamEvents.serverless.service.provider.iamRoleARN = 'abc';
      awsCompileStreamEvents.serverless.service.functions = {
        first: {
          events: [
            {
      ...
      delete awsCompileStreamEvents.serverless.service.provider.iamRoleARN;
    });
  });
});
