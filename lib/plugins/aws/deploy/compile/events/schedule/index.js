      ...
      if (functionObj.events) {
        functionObj.events.forEach(event => {
          if (event.schedule) {
            ...
            const cloudWatchEventId = naming.getCloudWatchEventId(functionName);
            const logicalEventName = naming.getCloudWatchEventName(functionName, scheduleIndex);
            const permissionName = naming.getLambdaCloudWatchEventPermissionName(
