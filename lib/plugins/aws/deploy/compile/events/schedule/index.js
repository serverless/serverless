      ...
      if (functionObj.events) {
        functionObj.events.forEach(event => {
          if (event.schedule) {
            ...
            const cloudWatchEventId = this.sdk.naming.getCloudWatchEventId(functionName);
            const logicalEventName = this.sdk.naming
              .getCloudWatchEventName(functionName, scheduleIndex);
            const permissionName = this.sdk.naming.getLambdaCloudWatchEventPermissionName(
              functionName, scheduleIndex);
