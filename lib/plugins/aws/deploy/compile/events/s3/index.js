...
class AwsCompileS3Events {
  ...
  compileS3Events() {
          ...
          if (event.s3) {
            ...
            if (bucketsLambdaConfigurations[bucketName]) {
              let newLambdaConfiguration = {
                ...
                Function: {
                  'Fn::GetAtt': [
                    this.sdk.naming.getLogicalLambdaName(functionName),
                    'Arn',
                  ],
                },
              };
    ...
    _.forEach(bucketsLambdaConfigurations, (bucketLambdaConfiguration, bucketName) => {
      ...
      const bucketLogicalID = this.sdk.naming.getLogicalBucketName(bucketName);
    ...
    s3EnabledFunctions.forEach(functionName => {
      ...
      const permissionLogicalID = this.sdk.naming.getLambdaS3PermissionName(functionName);
