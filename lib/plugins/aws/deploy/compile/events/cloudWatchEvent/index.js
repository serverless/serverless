        ...
        functionObj.events.forEach(event => {
          if (event.cloudwatchEvent) {
            ...
            const cloudWatchLogicalId = this.provider.naming
              .getEventsRuleLogicalId(functionName, cloudWatchEventNumberInFunction);
            const lambdaPermissionLogicalId = this.provider.naming
              .getLambdaEventsRulePermissionLogicalId(functionName,
                cloudWatchEventNumberInFunction);
            const cloudWatchId = this.provider.naming.getEventsRuleId(functionName);
