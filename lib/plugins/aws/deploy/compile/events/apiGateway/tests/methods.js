...
describe('#compileMethods()', () => {
    ...
    .compileMethods().then(() => {
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersCreate', 'POST')
        ].Type
      ).to.equal('AWS::ApiGateway::Method');
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersList', 'GET')
        ].Type
      ).to.equal('AWS::ApiGateway::Method');
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersUpdate', 'PUT')
        ].Type
      ).to.equal('AWS::ApiGateway::Method');
    })
  );
  ...
  it('should create preflight method for CORS enabled resource', () => {
    ...
    return awsCompileApigEvents.compileMethods().then(() => {
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersCreate', 'OPTIONS')
          ].Properties.Integration.IntegrationResponses[0]
          .ResponseParameters['method.response.header.Access-Control-Allow-Origin']
      ).to.equal(origin);
      ...
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersUpdate', 'OPTIONS')
          ].Properties.Integration.IntegrationResponses[0]
          .ResponseParameters['method.response.header.Access-Control-Allow-Origin']
      ).to.equal(origin);
      ...
      expect(
        awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate.Resources[
          awsCompileApigEvents.sdk.naming.getLogicalApiGatewayMethodName('UsersDelete', 'OPTIONS')
          ].Properties.Integration.IntegrationResponses[0]
          .ResponseParameters['method.response.header.Access-Control-Allow-Origin']
      ).to.equal(origin);
