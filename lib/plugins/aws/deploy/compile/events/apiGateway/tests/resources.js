  ...
  it('should construct the correct resourceLogicalIds object', () => awsCompileApigEvents
    .compileResources().then(() => {
      const expectedResourceLogicalIds = {
        'bar/-': awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/-'),
        'foo/bar': awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('foo/bar'),
        foo: awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('foo'),
        'bar/{id}/foobar': awsCompileApigEvents.sdk.naming
          .getLogicalApiGatewayResourceName('bar/{id}/foobar'),
        'bar/{id}': awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/{id}'),
        'bar/{foo_id}/foobar': awsCompileApigEvents.sdk.naming
          .getLogicalApiGatewayResourceName('bar/{foo_id}/foobar'),
        'bar/{foo_id}': awsCompileApigEvents.sdk.naming
          .getLogicalApiGatewayResourceName('bar/{foo_id}'),
        'bar/foo': awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/foo'),
        bar: awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar'),
      };
  ...
  it('should create resource resources when http events are given', () => awsCompileApigEvents
    .compileResources().then(() => {
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('foo/bar')]
        .Properties.PathPart).to.equal('bar');
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('foo/bar')]
        .Properties.ParentId.Ref).to.equal(awsCompileApigEvents.sdk.naming
          .getLogicalApiGatewayResourceName('foo'));
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('foo')]
        .Properties.ParentId['Fn::GetAtt'][0])
        .to.equal(awsCompileApigEvents.sdk.naming.getLogicalApiGatewayName());
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar')]
        .Properties.ParentId['Fn::GetAtt'][1])
        .to.equal('RootResourceId');
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/{id}')]
        .Properties.ParentId.Ref)
        .to.equal(awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar'));
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/{foo_id}')]
        .Properties.ParentId.Ref)
        .to.equal(awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar'));
      expect(awsCompileApigEvents.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[awsCompileApigEvents.sdk.naming
          .getLogicalApiGatewayResourceName('bar/{foo_id}/foobar')]
        .Properties.ParentId.Ref)
        .to.equal(awsCompileApigEvents.sdk.naming.getLogicalApiGatewayResourceName('bar/{foo_id}'));
    })
  );
