...
describe('AwsDeploy', () => {
  ...
  describe('hooks', () => {
    ...
    describe('"before:deploy:deploy" hook', () => {
      let setDeploymentBucketObjectStub;
      ...
      beforeEach(() => {
        setDeploymentBucketObjectStub = sinon
          .stub(awsDeploy, 'setDeploymentBucketObject').resolves();
      ...
      afterEach(() => {
        awsDeploy.setDeploymentBucketObject.restore();
      ...
      it('should use the default packaging mechanism if no packaging config is provided', () => {
        ...
        return awsDeploy.hooks['before:deploy:deploy']().then(() => {
          ...
          expect(setDeploymentBucketObjectStub.calledAfter(spawnAwsCommonValidateStub))
            .to.equal(true);
          expect(extendedValidateStub.calledAfter(setDeploymentBucketObjectStub)).to.equal(true);
      ...
      it('should move the artifacts to the tmp dir if options based config is provided', () => {
        ...
        return awsDeploy.hooks['before:deploy:deploy']().then(() => {
          ...
          expect(setDeploymentBucketObjectStub.calledAfter(spawnAwsCommonValidateStub))
            .to.equal(true);
          expect(spawnAwsCommonMoveArtifactsToTemp.calledAfter(setDeploymentBucketObjectStub))
            .to.equal(true);
