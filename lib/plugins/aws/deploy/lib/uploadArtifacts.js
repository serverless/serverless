...
module.exports = {
  uploadArtifacts() {
    return BbPromise.bind(this)
      .then(this.enableBucketAcceleration)
      .then(this.uploadCloudFormationFile)
      .then(this.uploadFunctions);
  },

  enableBucketAcceleration() {
    // TODO only if enabled via config/option

    this.serverless.cli.log('Enabling S3 Transfer Acceleration...');
