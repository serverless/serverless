...
module.exports = {
  ...
  uploadFunctions() {
    ...
    const uploadPromises = functionNames.map(name => {
      ...
      if (functionObject.package.artifact && functionObject.package.artifact.includes('.serverless/functions')) {
        functionObject.package.individually = true;
      }
      if ((functionObject.package && functionObject.package.individually) || this.serverless.service.package.individually) {
