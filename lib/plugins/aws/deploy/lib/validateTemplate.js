...
module.exports = {
  async validateTemplate() {
    ...
    const deploymentDirectory = this.serverless.getProvider('aws').s3DeploymentDirectoryPath;
    ...
    const params = {
      TemplateURL: `https://${s3Endpoint}/${bucketName}/${deploymentDirectory}/${compiledTemplateFileName}`,
    };
