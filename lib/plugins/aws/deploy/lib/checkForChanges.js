...
module.exports = {
  ...
  async fixLogGroupSubscriptionFilters(params) {
    ...
    // Old subscription filters which doesn't have same destination with any of the new subscription filter.
    // This kind of subscription filters should be deleted unless it's from external stack.
    // Currently, we delete without checking it is from external stack or not if needed.
