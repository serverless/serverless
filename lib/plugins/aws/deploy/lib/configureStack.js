...
module.exports = {
  configureStack() {
    ...
    if (typeof this.serverless.service.provider.iamRoleARN !== 'string') {
      ...
      const logicalRoleName = this.sdk.naming.getLogicalRoleName();

      _.merge(this.serverless.service.provider.compiledCloudFormationTemplate.Resources,
        iamRoleLambdaExecutionTemplate);

      // set the necessary variables for the IAM role
      this.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[logicalRoleName]
        .Properties
        .Path = this.sdk.naming.getRolePath();
      this.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[logicalRoleName]
        .Properties
        .RoleName = this.sdk.naming.getRoleName();
      ...
      const logicalPolicyName = this.sdk.naming.getLogicalPolicyName();

      // set the necessary variables for the IamPolicyLambda
      iamPolicyLambdaExecutionTemplate[logicalPolicyName]
        .Properties
        .PolicyName = this.sdk.naming.getPolicyName();
      ...
      return BbPromise.bind(this)
        ...
        .then(result => {
          ...
          this.serverless.service.provider.compiledCloudFormationTemplate.Outputs[
              this.sdk.naming.getLogicalDeploymentBucketOutputVariableName()
            ].Value = bucketName;

          delete this.serverless.service.provider.compiledCloudFormationTemplate
            .Resources[this.sdk.naming.getLogicalDeploymentBucketName()];
        });
    }
