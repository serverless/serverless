...
module.exports = {
  configureStack() {
    ...
    if (typeof this.serverless.service.provider.iamRoleARN !== 'string') {
      ...
      const logicalRoleName = naming.getLogicalRoleName();
      ...
      this.serverless.service.provider.compiledCloudFormationTemplate
        ...
        .Properties
        .Path = naming.getRolePath();
      this.serverless.service.provider.compiledCloudFormationTemplate
        .Resources[logicalRoleName]
        .Properties
        .RoleName = naming.getRoleName();
    ...
    if (bucketName) {
      return BbPromise.bind(this)
        ...
        .then(result => {
          ...
          this.serverless.service.provider.compiledCloudFormationTemplate
            .Outputs[naming.getLogicalDeploymentBucketOutputVariableName()].Value = bucketName;
