  ...
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      'before:deploy:deploy': async () => {
        ...
        /**
         * If observability is configured, whether enabled or not
         * make sure we setup the integration context to decide what to do next
         */
        if (this.serverless.isObservabilityConfigured()) {
          this.observabilityIntegrationService =
            await observabilityIntegrationService(this.serverless)

          await this.observabilityIntegrationService.configureIntegrationContext()

          /**
           * Only create the integraiton (if it doesn't already exist) if observability is enabled
           */
