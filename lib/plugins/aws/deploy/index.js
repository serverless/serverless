...
class AwsDeploy {
  constructor(serverless, options) {
    ...
    this.serverless.cli.spinner.setSpinnerTitle(chalk.yellow('Starting Deployment '));
    ...
    this.hooks = {
      'before:deploy:initializeResources': () => BbPromise.bind(this)
          .then(() => this.serverless.cli.spinner.start())
          .then(this.validate),
      ...
      'deploy:deploy': () => BbPromise.bind(this)
        ...
        .then(() => this.serverless.cli.spinner.stop(true))
        .then(() => this.serverless.cli.log('Deployment Complete')),
    };
  }
}
