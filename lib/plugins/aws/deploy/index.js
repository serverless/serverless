...
import DashboardObservabilityIntegrationService from '@serverlessinc/sf-core/src/lib/observability/dashboard.js'
  ...
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      'before:deploy:deploy': async () => {
         ...
         */
        const configuredObservabilityProvider =
          determineObservabilityProviderFromConfig(
            this.serverless.configurationInput,
            this.provider.getStage(),
          )
        if (
          configuredObservabilityProvider === ObservabilityProvider.DASHBOARD
        ) {
