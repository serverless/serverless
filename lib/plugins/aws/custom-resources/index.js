...
async function addCustomResourceToService(awsProvider, resourceName, iamRoleStatements) {
  ...
  // configure vpc for the custom resource function
  providerConfig.vpc = providerConfig.vpc || { securityGroupIds: null, subnetIds: null };
  ...
  if (
    !customResourceFunction.Properties.VpcConfig.SecurityGroupIds ||
    !customResourceFunction.Properties.VpcConfig.SubnetIds
  ) {
    delete customResourceFunction.Properties.VpcConfig;
  }
