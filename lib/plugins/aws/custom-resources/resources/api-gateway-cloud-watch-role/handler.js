...
const { APIGatewayClient, GetAccountCommand, UpdateAccountCommand } = require('@aws-sdk/client-api-gateway');
const { IAMClient, ListAttachedRolePoliciesCommand, CreateRoleCommand, AttachRolePolicyCommand } = require('@aws-sdk/client-iam');
...
async function create(event, context) {
  ...
  const assignedRoleArn = (
    await apiGateway.send(new GetAccountCommand({}))
  ).cloudwatchRoleArn;
