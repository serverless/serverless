...
describe('#naming()', () => {
  ...
  describe('#getEventsRuleId()', () => {
    it('should add the standard suffix', () => {
      expect(sdk.naming.getEventsRuleId('functionName')).to.equal('functionNameEventsRule');
    });
  });

  describe('#getEventsRuleLogicalId()', () => {
    it('should normalize the function name and add the standard suffix including the index', () => {
      expect(sdk.naming.getEventsRuleLogicalId('functionName', 0))
        .to.equal('FunctionNameEventsRuleCloudWatch0');
    });
  });
  ...
  describe('#getLambdaEventsRulePermissionLogicalId()', () => {
    it('should normalize the function name and add the standard suffix including event index',
      () => {
        expect(sdk.naming.getLambdaEventsRulePermissionLogicalId('functionName', 0))
          .to.equal('FunctionNameLambdaPermissionEventsRuleCloudWatch0');
      });
  });
