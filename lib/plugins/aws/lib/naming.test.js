...
describe('#naming()', () => {
  ...
  describe('#normalizeNameToPascalCase()', () => {
    it('should capitalize the first letter', () => {
      expect(sdk.naming.normalizeNameToPascalCase('name')).to.equal('Name');
    });
    ...
    it('should convert from kebab case', () => {
      expect(sdk.naming.normalizeNameToPascalCase('test-name')).to.equal('TestName');
    });
    it('should convert from snake case', () => {
      expect(sdk.naming.normalizeNameToPascalCase('test_name')).to.equal('TestName');
    });
    it('should convert from camel case', () => {
      expect(sdk.naming.normalizeNameToPascalCase('testName')).to.equal('TestName');
    });
  });
  ...
  describe('#getScheduleLogicalId()', () => {
    it('should normalize the function name and add the standard suffix from index with no function name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 1)).to.equal(
        'FunctionNameEventsRuleSchedule1'
      );
    });
    it('should normalize the function name and add the standard suffix with simple schedule name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 0, 'first')).to.equal(
        'FunctionNameEventsRuleScheduleFirst'
      );
    });
    it('should normalize the function name and add the standard suffix with camel case schedule name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 0, 'firstSchedule')).to.equal(
        'FunctionNameEventsRuleScheduleFirstSchedule'
      );
    });
    it('should normalize the function name and add the standard suffix with simple schedule name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 0, 'firstschedule')).to.equal(
    ...
    it('should normalize the function name and add the standard suffix from kebab case schedule name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 0, 'first-1')).to.equal(
        'FunctionNameEventsRuleScheduleFirst1'
      );
    });
    it('should normalize the function name and add the standard suffix from snake case schedule name', () => {
      expect(sdk.naming.getScheduleLogicalId('functionName', 0, 'first_1')).to.equal(
        'FunctionNameEventsRuleScheduleFirst1'
      );
    });
  });
