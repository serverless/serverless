...
describe('#naming()', () => {
  ...
  describe('#getVpcLogicalId()', () => {
    it('should return the VPC logical id', () => {
      expect(sdk.naming.getVpcLogicalId()).to.equal('VPC');
    });
  });

  describe('#getInternetGatewayLogicalId()', () => {
    it('should return the Internet Gateway logical id', () => {
      expect(sdk.naming.getInternetGatewayLogicalId()).to.equal('InternetGateway');
    });
  });

  describe('#getVpcGatewayAttachmentLogicalId()', () => {
    it('should return the VPC Gateway Attachment logical id', () => {
      expect(sdk.naming.getVpcGatewayAttachmentLogicalId()).to.equal('VPCGatewayAttachment');
    });
  });

  describe('#getRouteTableLogicalId()', () => {
    it('should return the Route Table logical id', () => {
      expect(sdk.naming.getRouteTableLogicalId('test')).to.equal('RouteTableTest');
    });
  });

  describe('#getRouteLogicalId()', () => {
    it('should return the Route logical id', () => {
      expect(sdk.naming.getRouteLogicalId('test')).to.equal('RouteTest');
    });
  });

  describe('#getSubnetLogicalIdRegex()', () => {
    it('should match public subnets', () => {
      expect(sdk.naming.getSubnetLogicalIdRegex().test('SubnetPublicfoo')).to.equal(true);
    });

    it('should match private subnets', () => {
      expect(sdk.naming.getSubnetLogicalIdRegex().test('SubnetPrivatefoo')).to.equal(true);
    });

    it('should not match other subnets', () => {
      expect(sdk.naming.getSubnetLogicalIdRegex().test('SubnetOtherfoo')).to.equal(false);
    });
  });

  describe('#getSubnetLogicalId()', () => {
    it('should return the Subnet logical id', () => {
      expect(sdk.naming.getSubnetLogicalId('test')).to.equal('SubnetTest');
    });
  });

  describe('#getSubnetRouteTableAssociationLogicalId()', () => {
    it('should return the RouteTableAssociation logical id', () => {
      expect(sdk.naming.getSubnetRouteTableAssociationLogicalId('SubnetTest')).to.equal(
        'SubnetTestRouteTableAssociation'
      );
    });
  });

  describe('#getEipLogicalId()', () => {
    it('should return the EIP logical id', () => {
      expect(sdk.naming.getEipLogicalId()).to.equal('NatPublicIp');
    });
  });

  describe('#getNatGatewayLogicalId()', () => {
    it('should return the NatGateway logical id', () => {
      expect(sdk.naming.getNatGatewayLogicalId('SubnetTest')).to.equal('SubnetTestNatGateway');
    });
  });

  describe('#getLambdaSecurityGroupLogicalId()', () => {
    it('should return the Lambda SecurityGroup logical id', () => {
      expect(sdk.naming.getLambdaSecurityGroupLogicalId()).to.equal('LambdaSecurityGroup');
    });
  });

  describe('#getSecurityGroupLogicalId()', () => {
    it('should return the SecurityGroup logical id', () => {
      expect(sdk.naming.getSecurityGroupLogicalId('Test')).to.equal('TestSecurityGroup');
    });
  });
});
