...
describe('#naming()', () => {
  ...
  describe('#getCloudWatchId()', () => {
    it('should add the standard suffix', () => {
      expect(sdk.naming.getCloudWatchId('functionName')).to.equal('functionNameCloudWatch');
    });
  });

  describe('#getCloudWatchLogicalId()', () => {
    it('should normalize the function name and add the standard suffix including the index', () => {
      expect(sdk.naming.getCloudWatchLogicalId('functionName', 0))
  ...
  describe('#getLambdaCloudWatchPermissionLogicalId()', () => {
    it('should normalize the function name and add the standard suffix including event index',
      () => {
        expect(sdk.naming.getLambdaCloudWatchPermissionLogicalId('functionName', 0))
