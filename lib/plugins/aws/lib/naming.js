...
module.exports = {
  ...
  // Role
  getRolePath() {
    const customRolePath = _get(this.provider, 'serverless.service.provider.iam.role.path');
    return customRolePath || '/';
  },
  getRoleName() {
    const customRoleName = _get(this.provider, 'serverless.service.provider.iam.role.name');
    return (
      customRoleName || {
        'Fn::Join': [
          '-',
  ...
  getApiGatewayName() {
    ...
    return _get(this.provider.serverless.service.provider.apiGateway, 'shouldStartNameWithService')
  ...
  getHttpApiName() {
    ...
    return _get(this.provider.serverless.service.provider.httpApi, 'shouldStartNameWithService')
      ? `${this.provider.serverless.service.service}-${this.provider.getStage()}`
      : `${this.provider.getStage()}-${this.provider.serverless.service.service}`;
  },
  getHttpApiLogicalId() {
