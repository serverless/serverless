...
module.exports = {
  ...
  getRouteTableLogicalId(name) {
    return `RouteTable${this.normalizeNameToAlphaNumericOnly(name)}`;
  },
  getRouteLogicalId(name) {
    return `Route${this.normalizeNameToAlphaNumericOnly(name)}`;
  },
  getSubnetLogicalIdRegex() {
    return /^Subnet(Public|Private)[a-z0-9]+$/;
  },
  ...
  getNatGatewayLogicalId(subnetLogicalId) {
    return `${subnetLogicalId}NatGateway`;
  },
  getLambdaSecurityGroupLogicalId() {
    return this.getSecurityGroupLogicalId('Lambda');
  },
  getSecurityGroupLogicalId(name) {
    return `${name}SecurityGroup`;
  },
};
