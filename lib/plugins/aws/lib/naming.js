...
module.exports = {
  ...
  getLambdaApiGatewayPermissionLogicalId(functionName, resourceId, methodName) {
    return `${this.getNormalizedFunctionName(functionName)}LambdaPermission${resourceId}${this
      .normalizeMethodName(methodName)}ApiGateway`;
  },
  getLambdaApiGatewayAuthorizerPermissionLogicalId(functionName) {
