...
const { ALB_LISTENER_PATTERN } = require('../package/compile/events/alb/lib/validate');
              ...
              properties: {
                ...
                authorizers: {
                  ...
                  additionalProperties: {
                    type: 'object',
                    properties: {
                      type: { enum: ['cognito', 'oidc'] },
                      userPoolArn: { $ref: '#/definitions/awsArnString' },
