...
class AwsProvider {
  ...
  constructor(serverless, options) {
    ...
    if (ca) {
      ...
      // Replace the newline -- https://stackoverflow.com/questions/30400341/environment-variables-containing-newlines-in-node
      caArr.forEach(function(cert) {
        caCerts.push(cert.replace(/\\n/g, '\n'));
      });
    }
    ...
    if (cafile) {
      ...
      caPathArr.forEach(function(cafilePath) {
        caCerts.push(fs.readFileSync(cafilePath.trim()));
      });
    }
