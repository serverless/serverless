...
describe('AwsProvider', () => {
  ...
  describe('#getCredentials()', () => {
    ...
    beforeEach(() => {
      newAwsProvider = new AwsProviderProxyquired(serverless, options);
    });
  ...
  describe('#getRegion', () => {
    it('should prefer options over config or provider', () => {
      ...
      expect(newAwsProvider.getRegion()).to.equal(options.region);
    });
  ...
  describe('#getServerlessDeploymentBucketName', () => {
      ...
      return awsProvider.getServerlessDeploymentBucketName()
        .then((bucketName) => {
          ...
          expect(describeStackResourcesStub.calledWithExactly(
            ...
            {
              StackName: awsSdk.naming.getStackName(),
    ...
    describe('#getStage', () => {
      it('should prefer options over config or provider', () => {
        ...
        expect(awsProvider.getStage()).to.equal(options.stage);
      });
      it('should prefer config over provider in lieu of options', () => {
        const options = {};
        const config = {
