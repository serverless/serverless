    ...
    describe('using the request cache', () => {
      ...
      describe('STS tokens', () => {
        ...
        it('should retain reference to STS tokens when updated via SDK', () => {
          ...
          let startToken = newAwsProvider.getCredentials().credentials.sessionToken
          expect(startToken).to.be.undefined;
          ...
          class FakeCloudFormation {
            constructor(credentials) {
              ...
              credentials.credentials.sessionToken = expectedToken
            }
          ...
          return newAwsProvider
            ...
            .then(data => {
              ...
              let actualToken = newAwsProvider.getCredentials().credentials.sessionToken
