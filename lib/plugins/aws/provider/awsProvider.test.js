...
describe('AwsProvider', () => {
  ...
  describe('#getDeploymentPrefix()', () => {
    ...
    it('should throw error if prefix is longer than 16', () => {
      ...
      expect(awsProvider.getDeploymentPrefix()).to.throw(`Length of alb.targetGroupPrefix should be at most 16 but is ${serverless.service.provider.alb.targetGroupPrefix.Length}`);
    });
