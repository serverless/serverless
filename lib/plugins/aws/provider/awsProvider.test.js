        ...
        beforeEach(() => {
          ...
          serverless.utils.writeFileSync(
            ...
            '[default]\n' +
              ...
              '\n' +
              '[async_profile]\n' +
              'credential_process = echo \'{ "Version": 1, "AccessKeyId": "async_access_key_id", "SessionToken": "async_session_token" }\'\n'
          );
  ...
  describe('#getCredentials()', () => {
    ...
    const fakeCredentials = {
      ...
      asyncProfile: {
        ...
        // this should be simple enough to work on mac/windows/linux:
        cmd:
          'echo \'{ "Version": 1, "AccessKeyId": "async_access_key_id", "SessionToken": "async_session_token" }\'',
      },
    };
    ...
    beforeEach(() => {
      ...
      serverless.utils.writeFileSync(
        ...
        `[${fakeCredentials.aProfile.name}]\n` +
          ...
          `credential_process = ${fakeCredentials.asyncProfile.cmd}\n` +
          '\n'
      );
