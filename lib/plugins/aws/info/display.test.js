...
describe('#display()', () => {
  ...
  it('should display functions if given', () => {
    ...
    expectedMessage += `\n${chalk.yellow('functions:')}`;
    expectedMessage += '\n  function1:\n';
    expectedMessage += '    arn:aws:iam::12345678:function:function1';
    expectedMessage += '\n  function2:\n';
    expectedMessage += '    arn:aws:iam::12345678:function:function2';
    expectedMessage += '\n  function3:\n';
    expectedMessage += '    arn:aws:iam::12345678:function:function3';
