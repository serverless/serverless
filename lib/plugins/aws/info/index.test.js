...
describe('AwsInfo', () => {
  ...
  beforeEach(() => {
    ...
    getMetricsStub = sinon
      .stub(awsInfo, 'getMetrics').returns(BbPromise.resolve());
  ...
  describe('#constructor()', () => {
    ...
    it('should run promise chain in order for "info:info" hook', () =>
      awsInfo.hooks['info:info']().then(() => {
        ...
        expect(getApiKeyValuesStub.calledAfter(getMetricsStub)).to.equal(true);
