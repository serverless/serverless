...
describe('#getResourceCount()', () => {
  ...
  it('attach resourceCount from listStackResources call to this.gatheredData if result is available', () => {
      ...
      StackResourceSummaries:
       [ { LogicalResourceId: 'ApiGatewayDeployment1520814106863',
         ...
         { LogicalResourceId: 'HelloLambdaVersiongZDaMtQjEhvXacHdpTLnQ61zDCdI2IWVYCbuE50pj8',
           PhysicalResourceId: 'arn:aws:lambda:us-east-1:111111111111:function:hello-world-2-dev-hello:2',
