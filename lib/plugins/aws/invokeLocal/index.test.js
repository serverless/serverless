  ...
  const testRuntime = (functionName = 'hello', cliParams = []) => {
    describe('input resolution', () => {
      it('should accept no data', async () => {
        ...
        expect(testResult.stdoutData).to.not.be.empty;   
      })
      ...
      it('should support plain string data', async () => {
        ...
        expect(testResult.stdoutData).to.include('inputData');
      ...
      it('should support JSON string data', async () => {
        ...
        expect(testResult.stdoutData).to.deep.include({inputKey:'inputValue'});
      })
      })
