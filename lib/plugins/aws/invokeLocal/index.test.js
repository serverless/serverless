...
describe('AwsInvokeLocal', () => {
  ...
  beforeEach(function () {
    this.timeout(5000); // Shifted, as occasionally timeout error occured
    options = {
      stage: 'dev',
      region: 'us-east-1',
      function: 'first',
      ...
      it('should become lower over time', function () {
        ...
        return awsInvokeLocal.invokeLocalPython(
          ...
          'withRemainingTime').then(() => {
            ...
            if (error.code === 'ENOENT' && error.path === 'python2' && !process.env.CI) {
              ...
              try {
                ...
                // (Mocha doesn't call it -> https://github.com/mochajs/mocha/issues/3740)
                afterEachCallback();
              }
            }
            throw error;
      ...
      it('should become lower over time', function () {
        ...
        return awsInvokeLocal.invokeLocalRuby(
          ...
          'withRemainingTime').then(() => {
            ...
            if (error.code === 'ENOENT' && error.path === 'ruby' && !process.env.CI) {
              process.stdout.write(
