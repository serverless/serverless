...
module.exports = {
    Ref: (plugin, resource) => {
        return new Promise((resolve) => { resolve(resource.Properties.FunctionName); });
    },
    'Fn::GetAtt': (plugin, resource, resourceName, parameters, serviceConfig) => {
        ...
        switch(parameters[1]) {
            ...
            default:
                throw new ServerlessError(`Attribute (${parameters[1]}) for ${resource.Properties.FunctionName} not supported`);
        }
    }
}
