  ...
  invokeLocalNodeJs(handlerPath, handlerName, event, customContext) {
    ...
    function handleResult(result) {
      if (result instanceof Error) {
        return handleError.call(this, result);
    ...
    const callback = (err, result) => {
      ...
      if (err) {
        handleError.bind(this)(err);
      } else if (result) {
        handleResult.bind(this)(result);
      }
    };
    ...
    if (!hasResponded && !_.isUndefined(maybeThennable) && _.isFunction(maybeThennable.then)) {
