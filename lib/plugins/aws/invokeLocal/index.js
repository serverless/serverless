...
class AwsInvokeLocal {
  ...
  loadEnvVars() {
    ...
    const providerEnvVars = _.omitBy(this.serverless.service.provider.environment, _.isNull) || {};
    const functionEnvVars = _.omitBy(this.options.functionObj.environment, _.isNull) || {};
