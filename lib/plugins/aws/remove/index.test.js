...
describe('AwsRemove', () => {
  ...
  describe('#constructor()', () => {
    ...
    it('should run promise chain in order', () => {
      const validateStub = sinon.stub(awsRemove, 'validate').resolves();
      const emptyS3BucketStub = sinon.stub(awsRemove, 'emptyS3Bucket').resolves();
      const removeStackStub = sinon.stub(awsRemove, 'removeStack').resolves();
      const monitorStackStub = sinon.stub(awsRemove, 'monitorStack').resolves();
