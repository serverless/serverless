  ...
  describe('#constructor()', () => {
    ...
    it('should run promise chain in order', () => {
      ...
      return awsDeployFunction.hooks['deploy:function:deploy']().then(() => {
        ...
        expect(zipFunctionStub.calledAfter(checkIfFunctionExistsStub)).to.equal(true);
        expect(deployFunctionStub.calledAfter(zipFunctionStub)).to.equal(true);
        expect(cleanupStub.calledAfter(deployFunctionStub)).to.equal(true);
