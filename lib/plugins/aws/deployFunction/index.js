...
class AwsDeployFunction {
  ...
  updateFunctionConfiguration() {
    const params = omitEmpty({
      DeadLetterConfig: {
        TargetArn: this.options.functionObj.onError,
      },
      Description: this.options.functionObj.description,
      Environment: {
        Variables: this.options.functionObj.environment,
      },
      KMSKeyArn: this.options.functionObj.awsKmsKeyArn,
      FunctionName: this.options.functionObj.name,
      MemorySize: this.options.functionObj.memorySize,
      Role: this.options.functionObj.role,
      Timeout: this.options.functionObj.timeout,
      VpcConfig: {
        SecurityGroupIds: this.options.functionObj.vpc
          ? this.options.functionObj.vpc.securityGroupIds : undefined,
        SubnetIds: this.options.functionObj.vpc
          ? this.options.functionObj.vpc.subnetIds : undefined,
      },
    });
