...
class AwsDeployFunction {
  ...
  deployFunction() {
    ...
    // Get function stats
    var stats = fs.statSync(this.options.functionObj.artifact)
    var fileSizeInBytes = stats["size"]
    var fileSizeInMegabytes = fileSizeInBytes / 1000000.0;
    this.serverless.cli.log(`Uploading function: ${this.options.function} (${Math.round(fileSizeInMegabytes * 100) / 100}MB)...`);
