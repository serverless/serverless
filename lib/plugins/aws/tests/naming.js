  ...
  describe('#getLambdaApiGatewayPermissionLogicalId()', () => {
    it('should normalize the function name and append the standard suffix', () => {
      expect(sdk.naming.getLambdaApiGatewayPermissionLogicalId('functionName',
        'UsersCreate', 'get'))
        .to.equal('FunctionNameLambdaPermissionUsersCreateGetApiGateway');
    });
  });

  describe('#getLambdaApiGatewayAuthorizerPermissionLogicalId()', () => {
    it('should normalize the authorizer name and append the standard suffix', () => {
      expect(sdk.naming.getLambdaApiGatewayAuthorizerPermissionLogicalId('functionName'))
