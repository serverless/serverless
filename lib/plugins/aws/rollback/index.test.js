  ...
  describe('#setStackToUpdate()', () => {
      ...
      const s3Objects = [
        {
          ...
          Key: 'serverless/rollback/dev/2000000000000-2016-10-18T08:24:56.930Z/cloudformation-template-update-stack.json',
        },
        {
    ...
    it('should resolve set the artifactDirectoryName and resolve', () => {
      const s3Objects = [
        {
          // eslint-disable-next-line max-len
          Key: 'serverless/rollback/dev/1476779096930-2016-10-18T08:24:56.930Z/cloudformation-template-update-stack.json',
        },
        {
