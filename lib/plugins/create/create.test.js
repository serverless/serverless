...
describe('Create', () => {
  ...
  describe('#create()', () => {
    ...
    it('should generate scaffolding for "aws-codecommit-nodejs" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'aws-codecommit-nodejs';
    ...
    it('should generate scaffolding for "aws-codecommit-nodejs" ' +
      'template and override service name if user passed', () => {
      process.chdir(tmpDir);
      create.options.template = 'aws-codecommit-nodejs';
      create.options.name = 'my-awesome-service';
    ...
    it('should generate scaffolding for "aws-git-client-nodejs" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'aws-git-client-nodejs';
    ...
    it('should generate scaffolding for "aws-git-client-nodejs" ' +
      'template and override service name if user passed', () => {
      process.chdir(tmpDir);
      create.options.template = 'aws-git-client-nodejs';
      create.options.name = 'my-awesome-service';
