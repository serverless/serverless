  ...
  describe('#create()', () => {
    ...
    it('should generate scaffolding for "azure-nodejs" template', () => {
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('goodbye.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-event-hub" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-event-hub';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('eventHub.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-service-bus-queue" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-service-bus-queue';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('serviceBusQueue.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-service-bus-topic" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-service-bus-topic';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('serviceBusTopic.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-storage-blob" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-storage-blob';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('storageBlob.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-storage-queue" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-storage-queue';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('storageQueue.js');
      });
    });

    it('should generate scaffolding for "azure-nodejs-timer" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'azure-nodejs-timer';
      ...
      return create.create().then(() => {
        ...
        const srcContent = fs.readdirSync(`${tmpDir}/src/handlers`);
        expect(srcContent).to.include('hello.js');
        expect(srcContent).to.include('timer.js');
      });
    });
