  ...
  describe('#create()', () => {
    ...
    it('should generate scaffolding for "azure-nodejs" template', () => {
      ...
      return create.create().then(() => {
        ...
        expect(dirContent).to.include('hello.js');
        expect(dirContent).to.include('goodbye.js');
      });
    });
    ...
    it('should generate scaffolding for "twilio-runtime" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'twilio-runtime';
