...
describe('Create', () => {
  ...
  describe('#create()', () => {
    ...
    it('should create a renamed service in the directory if using the "path" option', () => {
      ...
      console.log("name is: " + create.options.name);
      ...
      return create.create().then(() => {
        ...
        console.log(serverlessYmlfileContent);
    ...
    it('should create a custom renamed service in the directory if using the "path" and "name" option', () => {
      const cwd = process.cwd();
      fse.mkdirsSync(tmpDir);
      process.chdir(tmpDir);
