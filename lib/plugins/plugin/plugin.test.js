...
describe('Plugin', () => {
  ...
  describe('#constructor()', () => {
    ...
    it('should have a "install:plugin:plugin" hook', () => {
      expect(plugin.hooks['install:plugin:plugin']).to.not.equal(undefined);
    });
    ...
    it('should have a "uninstall:plugin:plugin" hook', () => {
      expect(plugin.hooks['uninstall:plugin:plugin']).to.not.equal(undefined);
    });
  ...
  describe('#addPluginToServerlessFile()', () => {
    ...
    it('should add the pluginName to serverless file path for a .json file', () => {
      ...
      plugin.addPluginToServerlessFile('serverless-plugin-1');
  ...
  describe('#installPeerDependencies()', () => {
    ...
    it('should install peerDependencies if an installed plugin has ones', () => {
      ...
      plugin.installPeerDependencies(pluginName);
  ...
  describe('#uninstallPeerDependencies()', () => {
    ...
    it('should uninstall peerDependencies if an installed plugin has ones', () => {
      ...
      plugin.uninstallPeerDependencies(pluginName);
      expect(npmUninstallStub.calledWithExactly(
