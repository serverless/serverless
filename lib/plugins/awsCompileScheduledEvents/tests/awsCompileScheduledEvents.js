...
describe('awsCompileScheduledEvents', () => {
  ...
  beforeEach(() => {
    ...
    awsCompileScheduledEvents = new AwsCompileScheduledEvents(serverless, options);
  ...
  describe('#compileScheduledEvents()', () => {
    ...
    it('should compile scheduled events into CF resources', () => {
      ...
      const permissionResource = `
        {
          ...
          "Properties": {
            ...
            "SourceArn": { "Fn::GetAtt": ["helloSchedule", "Arn"] }
          }
        }
       `;
      ...
      expect(awsCompileScheduledEvents.serverless.service
        .resources.aws.Resources.helloSchedule)
        .to.deep.equal(JSON.parse(scheduleResrouce));
      expect(awsCompileScheduledEvents.serverless.service
        .resources.aws.Resources.helloSchedulePermission)
