  ...
  describe('#publishService()', () => {
    ...
    it('should send a minimal service request to the platform', () => {
      ...
      return platform.publishService().then(() => {
        ...
        expect(platform.serverless.cli.log.calledWithExactly(successLog)).to.be.equal(true);
        expect(platform.serverless.cli.log.calledWithExactly(url)).to.be.equal(true);
      });
    });
