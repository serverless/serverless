...
const RegisterAwsProvider = require('../../awsProvider');
...
describe('AwsDeploy', () => {
  ...
  let register = new RegisterAwsProvider(serverless);
  const options = {
    stage: 'dev',
    region: 'us-east-1',
  };
  ...
  describe('#constructor()', () => {
    ...
    it('should run "before:awsDeploy:initializeResources" hook promise chain in order', () => {
    ...
    it('should run "awsDeploy:initializeResources" hook promise chain in order', () => {
    ...
    it('should run "awsDeploy:createProviderStacks" hook promise chain in order', () => {
    ...
    it('should run "awsDeploy:awsDeploy" promise chain in order', () => {
