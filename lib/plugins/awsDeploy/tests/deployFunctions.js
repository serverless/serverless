...
describe('deployFunctions', () => {
  ...
  describe('#zipFunctions()', () => {
    xit('should zip a simple function', () => {
      // TODO: add a correct test
      // test below is commented out because it tests the old behavior
      ...
      return awsDeployMock.zipFunctions().then(() => {
        expect(awsDeployMock.deployedFunctions[0].zipFilePath).to.match(/.+\-\d+.zip/);
      });
      */
    });

    xit('should zip nested code', () => {
      // TODO: add a correct test
      // test below is commented out because it tests the old behavior
      // which created a temp directory
  ...
  describe('#uploadZipFilesToS3Bucket()', () => {
    xit('should upload the zip files to the S3 bucket', () => {
      // TODO: add a correct test
      // test below is commented out because it tests the old behavior
      // which created a temp directory
