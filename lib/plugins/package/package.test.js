...
describe('Package', () => {
  ...
  describe('hooks', () => {
    ...
    describe('before:package:compileFunctions', () => {
      it('should call deleteNullEnvVars', () => {
        expect(pkg.hooks['before:package:compileFunctions']()).to.be.fulfilled
        .then(() => expect(deleteNullEnvVarsStub).to.be.calledOnce);
      });
    });
