...
describe('#zipService()', () => {
  ...
  beforeEach(() => {
    ...
    // serverless.yml
    const serverlessYamlFilePath = path.join(tmpDirPath, 'serverless.yml');
    serverless.utils.writeFileSync(serverlessYamlFilePath, 'serverless.yml file content');
    // serverless.env.yml
    const serverlessEnvYamlFilePath = path.join(tmpDirPath, 'serverless.env.yml');
    serverless.utils.writeFileSync(serverlessEnvYamlFilePath, 'serverless.env.yml file content');
    // .git
