...
module.exports = {
  ...
  packageAll() {
    ...
    const filesToChmodPlusX = process.platform !== 'win32' ? [] :
      Object.values(this.serverless.service.functions)
        .map(f => Object.assign({ runtime: this.serverless.service.provider.runtime || 'node8.10' }, f))
  ...
  packageFunction(functionName) {
    ...
    if (process.platform === 'win32') {
      const runtime = functionName.runtime || this.serverless.service.provider.runtime || 'node8.10';
