...
module.exports = {
  ...
  getExcludes(exclude) {
    ...
    const pluginsLocalPath = this.serverless.service.plugins &&
      this.serverless.service.plugins.localPath;
    const localPathExcludes = pluginsLocalPath &&
      typeof pluginsLocalPath === 'string' ? [pluginsLocalPath] : [];
