...
describe('OpenWhiskCompileFunctions', () => {
  ...
  describe('#compileRules()', () => {
    it('should return rules object from events manifest definition', () => {
      ...
      const result = {
        myRule: { ruleName: 'myRule', action: 'myFunction',  trigger: 'myTrigger', namespace: 'myNamespace' },
        anotherRule: { ruleName: 'anotherRule', action: 'myFunction',  trigger: 'anotherTrigger', namespace: 'myNamespace' }
      };
  ...
  describe('#compileFunction()', () => {
    ...
    it('should allow service default parameters to override defaults', () => {
      ...
      openwhiskCompileFunctions.serverless.service.defaults = {
        memory: mem, timeout, runtime, overwrite,
      };
      return expect(
        openwhiskCompileFunctions.compileFunction('functionName', {
          actionName: name,
