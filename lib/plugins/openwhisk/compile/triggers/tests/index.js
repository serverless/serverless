...
describe('OpenWhiskCompileTriggers', () => {
  ...
  describe('#compileTriggerFeed()', () => {
    it('should define trigger feed without parameters', () => {
      ...
      const result = openwhiskCompileTriggers.compileTriggerFeed('/ns/testing', '/ns/package/action', {});
    ...
    it('should define trigger feed with parameters', () => {
      ...
      const result = openwhiskCompileTriggers.compileTriggerFeed('/ns/testing', '/ns/package/action', {hello: 'world'});
      return expect(result).to.deep.equal(expected);
    });
  });
