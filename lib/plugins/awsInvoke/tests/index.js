...
describe('AwsInvoke', () => {
  ...
  describe('#awsInvoke()', () => {
    let invokeStub;
    beforeEach(() => {
      invokeStub = sinon.stub(awsInvoke.aws, 'request').
    ...
    it('should awsInvoke with correct params', () => awsInvoke.invoke()
      .then(() => {
    ...
    it('should awsInvoke with other invocation type', () => {
