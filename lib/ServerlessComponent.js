    ...
    load() {
        ...
        return BbPromise.try(function() {
            ...
            .each(function(sf) {
                ...
                if (SUtils.fileExistsSync(path.join(fPath1, 's-function.json'))) { // XXX
                    ...
                    return BbPromise.resolve(fs.readdirSync(path.join(_this._config.fullPath, sf)))
                        .each(function(sf2) {
                            ...
                            if (SUtils.fileExistsSync(path.join(fPath2, 's-function.json'))) { // XXX
                                ...
                                return BbPromise.resolve(fs.readdirSync(path.join(_this._config.fullPath, sf, sf2)))
                                    .each(function(sf3) {
                                        ...
                                        // If s-function.json doesn't exist, look in 2 subfolders
                                        if (SUtils.fileExistsSync(path.join(fPath3, 's-function.json'))) { // XXX
