...
class ServerlessFunction {
  ...
  load() {
    ...
    _this.data.handler   = (_this.options.function && _this.options.module) ? path.posix.join('modules', _this.options.module, 'functions', _this.options.function, 'handler.handler') : '';
    ...
    _this.data.endpoints = [
      {
        "path": (_this.options.function && _this.options.module) ? path.posix.join(_this.options.module, _this.options.function) : '',
        "method": "GET",
