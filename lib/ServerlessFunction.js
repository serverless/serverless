...
class ServerlessFunction {
  ...
  getRuntime() {
    // we cannot use the State because it's outdated, we're creating a new component that the state is not aware of.
    // we could load the State again, but that will promisify this method and I think it's not worth it.
    let component = new this._S.classes.Component(this._S, {component: this._config.component});
