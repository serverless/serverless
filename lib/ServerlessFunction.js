...
class ServerlessFunction {
   ...
   * - Stage and Region are required since nameTemplate could use variables
   */
  ...
  getDeployedName(options) {
    ...
    if (options.stage && options.region && this.nameTemplate) {
      name = this.getPopulated({
        stage:  options.stage,
        region: options.region }).nameTemplate;
    }
