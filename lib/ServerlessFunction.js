  ...
  load() {
    ...
    return BbPromise.try(function() {
      ...
      .each(function(e, i) {
        ...
        return functionJson.endpoints[i].load() // XXX
      ...
      .each(function(e, i) {
        ...
        return functionJson.events[i].load() // XXX
          .then(function(instance) {
      ...
      .then(function() {
        ...
        if (!_this._S.classes.Component.isComponentDir( parentOne )) {
        ...
        if (!_this._S.classes.Component.isComponentDir( parentTwo )) {
        ...
        if (options && options.deep) {
          return BbPromise.try(function () {
            ...
            .each(function(endpoint) {
              ...
              return endpoint.save(); // XXX
            })
            .then(function () {
              return _this.events;
            })
            .each(function(event) {
              return event.save(); // XXX
            })
        }
      })
      .then(function() {
