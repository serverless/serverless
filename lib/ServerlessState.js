...
class ServerlessState {
  ...
  getFunctions(options) {
    ...
    if (options && options == { returnPaths: true }) return allFunctions.map(function(d) { return d._config.sPath });
  ...
  getEndpoints(options) {
    ...
    if (options && options == { returnPaths: true }) return allEndpoints.map(function(d) { return d._config.sPath });
