...
class Jaws {
  ...
  constructor(config) {
    ...
    if (this._projectRootPath) {
      ...
      this._awsAdminKeyId     = AWSUtils.profilesGet(this._awsProfile)[this._awsProfile].aws_access_key_id;
      this._awsAdminSecretKey = AWSUtils.profilesGet(this._awsProfile)[this._awsProfile].aws_secret_access_key;
    }
