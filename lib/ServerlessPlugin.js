...
class ServerlessPlugin {
  ...
  cliSelectInput(message, choices, multi, doneLabel) {
    if (this.S._interactive) { //CLI
  ...
  cliSelectFunctions(cwd, message, multi, skipSingles) {
    ...
    return SUtils.getFunctions(cwd, null)
        .then(function(functions) {
          ...
          // Show select input
          return _this.cliSelectInput(message, choices, multi)
