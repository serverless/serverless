...
module.exports = function(SPlugin, serverlessPath) {
  ...
  SERVERLESS_PROJECT_NAME=${this.evt.name}`;
    ...
    _createProjectJson() {
      ...
      prjJson.cloudFormation.Parameters.ProjectName.Default          = _this.evt.name;
      prjJson.cloudFormation.Parameters.ProjectName.AllowedValues    = [_this.evt.name];
      prjJson.cloudFormation.Parameters.ProjectDomain.Default        = _this.evt.domain;
      prjJson.cloudformation.Parameters.NotificationEmail.Default    = _this.evt.notificationEmail;
    ...
    _createStageAndRegion() {
      ...
      //TODO: Call StageCreate Action (Which calls RegionCreate Action)
