    ...
    return this.cliPromptInput(prompts, overrides)
        .then(function(answers) {
          ...
          if (!_this.evt.region) {
            ...
            return _this.cliSelectInput('Select a region for your project: ', choices, false)
                .then(results => {
        ...
        .then(function() {
          ...
          return _this.cliSelectInput('Select an AWS profile for your project: ', choices, false)
              .then(results => {
