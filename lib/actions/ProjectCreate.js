...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class ProjectCreate extends SPlugin {
    ...
    _createProjectScaffolding() {
      ...
      return SUtils.writeFile(
        ...
        .then(function() {
          ...
          _this.project.setProjectPath(_this.S._projectRootPath);
          _this.project.save();

          // Create and save meta
          _this.meta = new _this.S.classes.Meta();
          ...
          _this.meta.setProjectPath(_this.S._projectRootPath);
          _this.meta.save();
    ...
    _deployResources() {
      ...
      if (this.options.noExeCf) return BbPromise.resolve();
