...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class ProjectCreate extends SPlugin {
      ...
      let prompts = {
        properties: {
          ...
          domain:            {
            ...
            default:     _this.project.data.name + '.com',
          ...
          notificationEmail: {
            ...
            default:     'me@' + _this.project.data.name + '.com',
    ...
    _createProjectBucket() {
      ...
      this.projectBucket = SUtils.generateProjectBucketName(this.options.region, this.options.domain);

      SCli.log('Creating a project bucket on S3: ' + this.projectBucket + '...');
    ...
    _createProjectScaffolding() {
      ...
      return SUtils.writeFile(
        path.join(_this.S._projectRootPath, 'back', '.env'),
          'SERVERLESS_STAGE=' + _this.options.stage
          + '\nSERVERLESS_DATA_MODEL_STAGE=' + _this.options.stage
