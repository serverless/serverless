...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class ProjectCreate extends SPlugin {
      ...
      let prompts = {
        properties: {
          name:              {
            ...
            default:     _this.evt.options.name,
          ...
          domain:            {
            ...
            default:     _this.evt.options.name.toLowerCase() + '.com',
          ...
          notificationEmail: {
            ...
            default:     'me@' + _this.evt.options.name.toLowerCase() + '.com',
    ...
    _createProjectScaffolding() {
      ...
      // Prepare README.md
      let readme = '#' + _this.evt.options.name;
      ...
      return SUtils.writeFile(
        path.join(projectPath, '.env'),
          ...
          + '\nSERVERLESS_PROJECT_NAME=' + _this.evt.options.name
        )
        .then(function() {
