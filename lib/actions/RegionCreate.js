 ...
 * - Creates a new project S3 bucket for the new region and CF files
...
usage: serverless region create`,
    ...
    _validateAndPrepare() {
      ...
      _this.region  = new _this.S.classes.Region(_this.S, _this.stage, {name: _this.evt.options.region});
