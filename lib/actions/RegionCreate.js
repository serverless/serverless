...
usage: serverless region create`,
    ...
    regionCreate(options) {
      ...
      this.meta = new this.S.classes.Meta({
        projectPath: this.S._projectRootPath
      });
    ...
    _prompt() {
      ...
      if (!_this.S._interactive || (_this.options.stage && _this.options.region)) return BbPromise.resolve();
    ...
    _validateAndPrepare() {
      ...
      if (!_this.meta.private.stages[_this.options.stage]) {
      ...
      if (_this.meta.private.stages[_this.options.stage].regions[_this.options.region]) {
        return BbPromise.reject(new SError('Region "' + _this.options.region + '" is already defined in the stage "' + _this.options.stage + '"'));
      }

      // Set Global Meta
      _this.meta.private.stages[_this.options.stage].regions[_this.options.region] = {
        variables: {}
      };
