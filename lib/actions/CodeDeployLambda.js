...
module.exports   = function(SPlugin, serverlessPath) {
  ...
  class Deployer {
    ...
    _validateAndPrepare() {
      ...
      awsConfig.region = _this.evt.options.region;
      
      _this.S3       = require('../utils/aws/S3')(awsConfig);
      _this.Lambda   = require('../utils/aws/Lambda')(awsConfig);
      _this.AwsMisc  = require('../utils/aws/Misc'); // TODO delete this line?  Why does this exist?  It appears to be unused in this file and doesn't allow for configuration.  There is the more global require of this module.
