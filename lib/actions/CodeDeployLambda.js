...
module.exports   = function(SPlugin, serverlessPath) {
  ...
  class Deployer {
    ...
    _upload() {
      ...
      let d    = new Date(),
        s3Bucket = _this.project.getVariables().projectBucket,
        projectBucketRegion  = _this.project.getVariables().projectBucketRegion,
      ...
      return _this.aws.request('S3', 'upload', params, _this.evt.options.stage, projectBucketRegion)
        .then(function (s3Key) {
