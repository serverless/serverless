          ...
          .then(envMapsByRegion => {
            ...
            envMapsByRegion.forEach(mapForRegion => {
              ...
              if (_this.evt.stage == 'local') {
                ...
                let bucket = SUtils.getRegionConfig(_this.S._meta, _this.evt.stage, mapForRegion.regionName).variables.regionBucket;
                putEnvQ.push(S3.sPutEnvFile(bucket, _this.S._project.name, _this.evt.stage, _this.evt.region, contents));
              }
            });
