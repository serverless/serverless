    ...
    functionRunLambdaNodeJs(evt) {
      ...
      return new BbPromise(function(resolve) {
        ...
        try {
          ...
          functionFile        = path.join(process.cwd(), _this.function.getFilePath(), (functionFile + '.js'));
          functionHandler     = require(functionFile)[functionHandler];



          // Fire function
          let functionEvent = SUtils.readAndParseJsonSync(path.join(_this.function.getFilePath(), 'event.json'));
