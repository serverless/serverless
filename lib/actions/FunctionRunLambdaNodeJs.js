  ...
  class FunctionRunLambdaNodeJs extends SPlugin {
    ...
    functionRunLambdaNodeJs(evt) {
      ...
      _this.function = new _this.S.classes.Function(_this.S, {
        module:   _this.evt.options.path.split('/')[0],
        function: _this.evt.options.path.split('/')[1]
      });
      ...
      return new BbPromise(function(resolve) {
        ...
        try {
          ...
          let functionPath    = path.join(_this.S.config.projectPath, 'back', 'modules', _this.function.module, 'functions', _this.function.data.name);
