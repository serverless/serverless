...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class EventDeployStreamLambda extends SPlugin {
    ...
    eventDeployStreamLambda(evt) {
      ...
      if (!_this.evt.options.stage || !_this.evt.options.region || !_this.evt.options.event || !_this.evt.options.event.config.lambdaArn || !_this.evt.options.event.config.streamArn) {
