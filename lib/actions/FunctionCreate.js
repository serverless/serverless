...
usage: serverless function create <function>`,
    ...
    _validateAndPrepare() {
      ...
      this.options.functionPath = path.join(this.S.config.projectPath, 'back', 'modules', this.options.module, 'functions', this.options.function);
      if (SUtils.dirExistsSync(this.options.functionPath)) {
