...
usage: serverless function create <function>`,
    ...
    _promptModuleFunction() {
      ...
      let prompts = {
        properties: {
          ...
          function: {
            description: 'Enter a name for your new function: '.yellow,
    ...
    _validateAndPrepare() {
      ...
      if (!SUtils.doesModuleExist(this.evt.module, this.S._projectRootPath)) {
      ...
      if (SUtils.doesFunctionExist(this.evt.function, this.evt.module, this.S._projectRootPath)) {
        return BbPromise.reject(new SError(
      ...
      this.evt.module            = SUtils.getModule(this.evt.module, this.S._projectRootPath);
