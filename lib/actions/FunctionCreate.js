...
usage: serverless function create <function>`,
    ...
    _prompt() {
      ...
      return BbPromise.try(function() {
        ...
        .then(function() {
          ...
          // Prompt user with component, if they are in project root

          // Skip, if we're in component dir
          if (_this.evt.options.path || !SUtils.fileExistsSync(path.join(process.cwd(), 's-project.json'))) {
            return BbPromise.resolve();
          }
    ...
    _createFunction() {
      ...
      pathArray.shift(); // remove component from path
