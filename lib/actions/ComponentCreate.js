...
usage: serverless component create`,
    ...
    _validateAndPrepare() {
      ...
      if (this.S.getProject().validateComponentExists(this.evt.options.sPath, this.S.getProject().getRootPath())) {
    ...
    _createComponentSkeleton() {
      let component  = new this.S.classes.Component(this.S, this.S._project, {
