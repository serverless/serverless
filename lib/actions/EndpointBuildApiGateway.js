...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Builder {
    ...
    _validateAndPrepare() {
      ...
      return _this.endpoint.getPopulated({ stage: _this.evt.options.stage, region: _this.evt.options.region })
    ...
    _fetchDeployedLambda() {
      ...
      let params = {
        FunctionName: _this.Lambda.sGetLambdaName(_this.project.name, endpointInstance._config.component, endpointInstance._config.module, endpointInstance._config.function), /* required */
