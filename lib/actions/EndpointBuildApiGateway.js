...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Builder {
    ...
    build(options) {
      ...
      return _this._validateAndPrepare()
        ...
        .then(function() {
          ...
          _this.endpoint.url = 'https://'
            +  _this.meta.data.private.stages[_this.options.stage].region[_this.options.region].variables.apiGatewayApi
            + '.execute-api.'
    ...
    _validateAndPrepare() {
      ...
      _this.restApiId            = _this.endpoint.restApiId ? _this.endpoint.restApiId : _this.meta.data.private.stages[_this.options.stage].regions[_this.options.region].variables.apiGatewayApi;
      _this.resource             = null;
    ...
    _fetchDeployedLambda() {
      ...
      let _this = this;
      let params = {
        FunctionName: _this.Lambda.sGetLambdaName(_this.S.data.project.get('name'), _this.endpoint._module, _this.endpoint._function), /* required */
    ...
    _getApiResources() {
      ...
      let params = {
        restApiId: _this.restApiId, /* required */
        limit: 500
      };

      // List all Resources for this REST API
      return SUtils.autoRetryRequest(function() { return _this.ApiGateway.getResourcesPromised(params); })
