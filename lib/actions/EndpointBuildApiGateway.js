...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Builder {
    ...
    _validateAndPrepare() {
      ...
      _this.awsAccountNumber     = _this.meta.data.private.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.iamRoleArnLambda.replace('arn:aws:iam::', '').split(':')[0];
      _this.restApiName          = _this.meta.data.private.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.apiGatewayApi;
      _this.resource             = null;
