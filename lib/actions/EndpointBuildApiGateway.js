...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Builder {
    ...
    _fetchDeployedLambda(evt) {
      ...
      let _this = this;
      let params = {
        FunctionName: _this.Lambda.sGetLambdaName(_this.S._projectJson, evt.endpoint.module, evt.endpoint.function), /* required */
        Qualifier:    evt.stage
      };
      ...
      for (let property in requestTemplates) {
        if (requestTemplates.hasOwnProperty(property)) {
          if(typeof requestTemplates[property] === 'object') { // this code adding a JSON object case for valid values of requestTemplates key's values.  If more variants are added, a more careful inspection of requestTemplates[property] will be important.
            ret[property] = JSON.stringify(requestTemplates[property], null, 2);
          } else {
    ...
    _createEndpointIntegration(evt) {
      ...
      let params = {
        ...
        requestTemplates:       _this.prepareRequestTemplates(evt.endpoint.requestTemplates),
