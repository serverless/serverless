...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class EndpointBuildApiGateway extends SPlugin {
    ...
    endpointBuildApiGateway(options) {
  ...
  class Builder {
    ...
    _validateAndPrepare() {
      ...
      _this.endpoint             = _this.project.getEndpoints({
        paths:    [_this.options.path],
        populate: true,
        stage:    _this.options.stage,
        region:   _this.options.region
      })[0];
      _this.awsAccountNumber     = _this.meta.data.private.stages[_this.options.stage].regions[_this.options.region].variables.iamRoleArnLambda.replace('arn:aws:iam::', '').split(':')[0];
      _this.restApiName          = _this.meta.data.private.stages[_this.options.stage].regions[_this.options.region].variables.apiGatewayApi;
      _this.resource             = null;
    ...
    _getRestApi() {
      ...
      return _this.ApiGateway.sGetApiByName(_this.restApiName, _this.options.stage, _this.options.region)
    ...
    _getApiResources() {
      ...
      return SUtils.persistantRequest(function() { return _this.ApiGateway.getResourcesPromised(params); })
    ...
    _createEndpointResources() {
      ...
      return new BbPromise(function(resolve, reject) {
        ...
        async.eachSeries(eResources, function(eResource, cb) {
          ...
          // Create Resource
          return SUtils.persistantRequest(function() { return _this.ApiGateway.createResourcePromised(params); } )
            .then(function(response) {
    ...
    _createEndpointMethod() {
      ...
      return SUtils.persistantRequest( function(){ return _this.ApiGateway.getMethodPromised(params); } )
        .then(function(response) {
          ...
          return SUtils.persistantRequest( function(){ return _this.ApiGateway.deleteMethodPromised(params); } )
            .then(function(response) {
    ...
    _createEndpointIntegration() {
      ...
      let alias;
      if (_this.options.aliasEndpoint) alias  = _this.options.aliasEndpoint;
      ...
      // Create Integration
      return SUtils.persistantRequest( function(){ return _this.ApiGateway.putIntegrationPromised(params); } )
        .then(function(response) {
    ...
    _createEndpointMethodResponses() {
      ...
      return BbPromise.try(function() {
        ...
        .each(function(responseKey) {
          ...
          return SUtils.persistantRequest( function(){ return _this.ApiGateway.putMethodResponsePromised(params); } )
            .then(function() {
    ...
    _createEndpointMethodIntegResponses() {
      ...
      return BbPromise.try(function() {
        ...
        .each(function(responseKey) {
          ...
          return SUtils.persistantRequest( function(){ return _this.ApiGateway.putIntegrationResponsePromised(params); } )
            .then(function() {
