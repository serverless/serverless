...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Builder {
    ...
    _validateAndPrepare() {
      ...
      _this.endpoint = _this.S.getProject().getEndpoint( _this.evt.options.path );
    ...
    _createEndpointMethod() {
      ...
      return SUtils.persistentRequest( function(){ _this.aws.request('ApiGateway', 'getMethod', params, _this.evt.options.stage, _this.evt.options.region); } )
        .then(function(response) {
