...
module.exports = function(SPlugin, serverlessPath) {
  ...
  return class FunctionLogs extends SPlugin {
    ...
    _validateAndPrepare() {
      ...
      if (this.S.cli && !this.evt.options.name) {
      ...
      if (!this.S.cli && !this.evt.options.name) throw new SError(`Please provide a function name as a parameter`);

      this.function = this.S.getProject().getFunction(this.evt.options.name);
