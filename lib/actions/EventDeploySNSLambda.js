...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class EventSNSLambda extends SPlugin {
    ...
    static getName() {
      return 'serverless.core.' + EventSNSLambda.name;
    }

    registerActions() {

      this.S.addAction(this.eventSNSLambda.bind(this), {
        handler:       'eventSNSLambda',
