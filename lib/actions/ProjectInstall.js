  ...
  class ProjectInstall extends SPlugin {
      ...
      return new BbPromise(function (resolve, reject) {
        ...
        child = exec('npm install ' + _this.evt.options.project,
          function (error, stdout, stderr) {
            ...
            try {
              fs.mkdirSync(path.join(process.cwd(), _this.evt.options.project));
    ...
    _initProject() {
      ...
      return this.S.actions.projectInit({
        options: {
          name: this.evt.options.project,
          domain: this.evt.options.domain,
          stage: this.evt.options.stage,
          region: this.evt.options.region,
          notificationEmail: this.evt.options.notificationEmail,
