    ...
    _processDeployment(evt) {
      ...
      return BbPromise.try(function() {
          ...
          .then(function() {
            ...
            if( evt.failed ){
              SCli.log('FAILED to deploy the following functions in "' + evt.stage + '" to the following regions:');
    ...
    _deployCodeByRegion(evt, region) {
      ...
      return new BbPromise(function(resolve, reject) {
        ...
        async.eachLimit(evt.functions, 5, function(func, cb) {
          ...
          // Process sub-Actions
          let subaction = (evtClone.function.module.runtime === 'python2.7') ? _this.S.actions.codePackageLambdaPython2(evtClone) : _this.S.actions.codePackageLambdaNodejs(evtClone);
