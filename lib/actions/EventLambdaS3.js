  ...
  class EventLambdaS3 extends S.classes.Plugin {
    ...
    eventLambdaS3(evt) {
      ...
      return _this.aws.request('Lambda', 'removePermission', params, stage, region)
        ...
        .then(function() {
          let projectBucketRegion = S.getProject().getVariables().projectBucketRegion;
          let params = {
          ...
          return _this.aws.request('S3', 'putBucketNotificationConfiguration', params, stage, projectBucketRegion);
        })
        .then(function(data) {
