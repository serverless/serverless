...
usage: serverless module install <github-url>`,
    ...
    _validateAndPrepare() {
      ...
      _this.evt.module.pathModule = path.join(this.S.config.projectPath, 'back', 'modules', srcModuleJson.name);
    ...
    _updateCfTemplate() {
      ...
      let _this             = this,
          projectCfPath     = path.join(_this.S.config.projectPath, 'cloudformation'),
