...
usage: serverless module create`,
    ...
    moduleCreate(options) {
      ...
      this.module              = new this.S.classes.Module(this.S);
      this.module.data.name    = _this.options.module || this.module.data.name;
      this.module.data.runtime = _this.options.runtime || this.module.data.runtime;
    ...
    _promptModuleFunction() {
      ...
      return _this.cliPromptInput(prompts, overrides)
        .then(function(answers) {
          _this.module.data.name = answers.module;
    ...
    _installModuleDependencies() {
      ...
      SUtils.npmInstall(path.join(this.S.config.projectPath, this.options.module.pathModule));
      return BbPromise.resolve();
    }
  }
