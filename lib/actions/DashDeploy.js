...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class DashDeploy extends SPlugin {
    ...
    _validateAndPrepare() {
      ...
      if (!_this.componentName && !_this.moduleName) options = null;

      // Get functions and endpoints
      _this.functions = _this.S.state.getFunctions(options);
      _this.endpoints = _this.S.state.getEndpoints(options);
