  ...
  class DashDeploy extends SPlugin {
    ...
    _validateAndPrepare() {
      ...
      if (isModule) {
        ...
        return BbPromise.reject(new SError('Please go into one of your components folders to use the deployment dashboard.'));
      }
    ...
    _prompt() {
      ...
      // Show select input
      return _this.cliPromptSelect('Select the ' + (_this.moduleName ? 'module' : 'component') + ' assets you wish to deploy:', choices, true, 'Deploy')
        .then(function(items) {
