...
usage: serverless env get`,
  ...
  envGet(evt) {
    ...
    return _this.S.validateProject()
      ...
      .then(_this._getEnvVar)
        .then(function(evt) {
          console.log("------- EnvGet Event: ", _this.evt);
          return evt;
        });
  }
  ...
  _promptKey(){
    ...
    return this.cliPromptInput(prompts, null)
  ...
  _promptRegion(){
    ...
    return _this.cliPromptSelect('Select a region to get env var from: ', choices, false)
      .then(results => {
