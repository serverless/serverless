  ...
  class EventCWLogs extends S.classes.Plugin {
    ...
    eventCWLogs(evt) {
      ...
      let event          = S.getProject().getEvent( _this.evt.options.name ),
          ...
          filterName        = loggroup.filterName,
          filterPattern    = loggroup.filterPattern ? loggroup.filterPattern : 'nofilter',
      ...
      return _this.aws.request('Lambda', 'removePermission', params, stage, region)
        ...
        .then(function(data) {
          var loggroup = data.logGroups[0];
          SCli.log('Log Group: '+loggroup.logGroupName+"\nARN: "+loggroup.arn);
