...
module.exports    = function(SPlugin, serverlessPath) {
    ...
    class FunctionRun extends SPlugin {
        ...
        _runDeployed() {
            ...
            _this.evt.options.region          = _this.evt.options.region || _this.S.getProject().getRegions(_this.evt.options.stage)[0];
            ...
            if (_this.evt.options.region && !_this.S.getProject().getRegions(_this.evt.options.stage).indexOf(_this.evt.options.region) == -1) {
