...
module.exports    = function(SPlugin, serverlessPath) {
    ...
    class FunctionRun extends SPlugin {
        ...
        _validateAndPrepare() {
            ...
            let func = _this.S.getProject().getFunction( _this.evt.options.path );
            if (!func) {
                return BbPromise.reject(new SError(`You must be in a function folder to run it`));
            }
            _this.function = func;
        ...
        _runDeployed() {
            ...
            let params = {
                ...
                Payload: new Buffer(JSON.stringify(require(path.join(_this.function._config.fullPath, 'event')))), // XXX
