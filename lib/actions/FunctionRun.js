...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class FunctionRun extends SPlugin {
    ...
    functionRun(evt) {
      ...
      _this.function = _this.project.getFunctions({ paths: [_this.evt.options.path] })[0];
    ...
    _runByRuntime() {
      ...
      if (_this.project.data.components[_this.function.config.component].runtime === 'nodejs') {
