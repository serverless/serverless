...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class FunctionRun extends SPlugin {
    ...
    _loadTestEvent(evt) {
      ...
      let _this = this,
       eventPathSpecific = path.join(_this.S._projectRootPath, evt.function.pathFunction, evt.function.name + '-event.json'),
       eventPathGeneral  = path.join(_this.S._projectRootPath, evt.function.pathFunction, 'event.json'),
       testEvent         = {};
    ...
    _runFunction(evt) {
      ...
      } else if (evt.function.module.runtime === 'python2.7') {
