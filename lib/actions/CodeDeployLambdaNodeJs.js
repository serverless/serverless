...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class Deployer {
    ...
    _deploy(evt) {
      ...
      var params = {
        FunctionName: _this.Lambda.sGetLambdaName(_this.S._projectJson, evt.function.module, evt.function),
        Qualifier:    '$LATEST'
      };
          ...
          .then(function() {
            ...
            if (!lambda) {
              ...
              let params = {
                ...
                FunctionName: _this.Lambda.sGetLambdaName(_this.S._projectJson, evt.function.module, evt.function), /* required */
