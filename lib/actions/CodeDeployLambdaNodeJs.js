...
/**
 * Action: Code Deploy: Lambda: Nodejs
        ...
        .then(function () {
          ...
          if (!_this.lambda) {
            ...
            let params = {
              ...
              FunctionName: _this.Lambda.sGetLambdaName(_this.project.name, _this.evt.options.component, _this.evt.options.module, _this.function.name), /* required */
