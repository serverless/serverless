    ...
    _upload() {
      ...
      return _this.S3.sPutLambdaZip(
        ...
        .then(function (s3Key) {
          ...
          // Store S3 Data
          _this.s3Bucket = _this.meta.data.variables.projectBucket;
          _this.s3Key = s3Key;
        ...
        .then(function () {
          ...
          if (!_this.lambda) {
            ...
            let params = {
              ...
              Role:         _this.meta.data.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.iamRoleArnLambda, /* required */
            ...
            let params = {
              ...
              MemorySize:   _this.function.data.memorySize,
              Role:         _this.meta.data.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.iamRoleArnLambda,
              Timeout:      _this.function.data.timeout
            };
