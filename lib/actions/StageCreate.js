...
usage: serverless stage create`,
    ...
    _createStage() {
      ...
      this.stage = new this.S.classes.Stage(this.S, project, this.evt.options.stage);
      this.stage.getVariables().updateConfig({
        filePath: this.project.getFilePath('_meta', 'variables', `s-variables-${this.evt.options.stage}.json`)
      });
