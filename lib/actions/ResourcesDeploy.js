...
usage: serverless resources deploy`,
  ...
  .then(function(){ // TODO: implement deploy to "all" regions, or make it default.
      return _this.cliPromptSelectRegion('Which region are you deploying to: ', true, _this.evt.region, _this.evt.stage)
        .then(region => {
