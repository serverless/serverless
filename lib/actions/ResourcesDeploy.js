...
usage: serverless resources deploy`,
  ...
  resourcesDeploy(evt) {
    ...
    return this.S.validateProject()
      ...
      .then(() => {
        ...
        SCli.log('Resource Deployer:  Successfully deployed ' + _this.evt.stage + ' resources to ' + _this.evt.region);
        return _this.evt;
      });
  }
  ...
  _promptRegion(){
    ...
    return _this.cliSelectInput('Which region are you deploying to: ', choices, false)
      .then(results => {
