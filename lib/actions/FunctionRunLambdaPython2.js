    ...
    functionRunLambdaPython2(evt) {
      ...
      return new BbPromise(function(resolve) {
        ...
        try {
          ...
          let functionEvent   = SUtils.readAndParseJsonSync(path.join(_this.function.getFullPath(), 'event.json'));
          functionFile        = path.join(process.cwd(), _this.function.getFilePath1(), (functionFile + '.py'));
