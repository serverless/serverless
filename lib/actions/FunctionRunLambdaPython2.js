    ...
    functionRunLambdaPython2(evt) {
      ...
      return new BbPromise(function(resolve) {
        ...
        try {
          ...
          let functionEvent   = SUtils.readAndParseJsonSync(path.join(_this.function._config.fullPath, 'event.json'));  // XXX

          functionFile        = path.join(_this.function._config.fullPath, (functionFile + '.py')); // XXX
