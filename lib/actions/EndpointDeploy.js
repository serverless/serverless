  ...
  class EndpointDeploy extends SPlugin {
    ...
    _validateAndPrepare() {
      ...
      if (_this.S.cli &&
        ...
        _this.evt.options.paths = _this.S.getProject().getAllEndpoints({
          paths: [sPath],
          returnPaths: true
        });
      ...
      if (_this.evt.options.all) {
        _this.evt.options.paths = _this.S.getProject().getAllEndpoints({ returnPaths: true });
      }
          ...
          return new BbPromise(function(resolve, reject) {
            ...
            async.eachSeries(_this.evt.options.paths, function(path, eCb) {
              ...
              return BbPromise.try(function() {
                  ...
                  endpoint = _this.S.getProject().getEndpoint( path );
                ...
                .catch(function(e) {
                  ...
                  _this.failed[region].push({
                    sPath:            endpoint ? endpoint.getSPath() : path,
    ...
    _findOrCreateRestApi(restApiName, stage, region) {
      ...
      let aws = this.S.getProvider('aws');

      return aws.getApiByName(restApiName, stage, region)
        .then(function(restApi) {
          ...
          return aws.request('APIGateway', 'createRestApi', params, stage, region)
