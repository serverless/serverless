...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class EndpointDeploy extends SPlugin {
    ...
    _deployEndpointsByRegion(region) {
      ...
      let restApi;
      if (_this.meta.data.private.stages[_this.options.stage].regions[region].variables['apiGatewayApi']) {
        restApi = _this.meta.data.private.stages[_this.options.stage].regions[region].variables['apiGatewayApi'];
      } else {
      ...
      return ApiGateway.sFindOrCreateRestApi(
        ...
        .then(function(restApiData) {
          ...
          // Persist API to meta
          _this.meta.data.private.stages[_this.options.stage].regions[region].variables['apiGatewayApi'] = restApiData.name;
          _this.meta.save();
