...
Usage: serverless env list`,
    ...
    _validateAndPrepare() {
      ...
      return BbPromise.resolve(_this.S.getProject().getAllFunctions())
          .then(functions => {
            return [functions, SUtils.getEnvFiles(_this.S, _this.evt.options.region, _this.evt.options.stage)];
          })
