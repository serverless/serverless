...
class EndpointProvisionApiGateway extends SPlugin {
  ...
  static getName() {
    return 'serverless.core.' + EndpointProvisionApiGateway.name;
  }
  ...
  registerActions() {
    this.S.addAction(this.endpointProvisionApiGateway.bind(this), {
