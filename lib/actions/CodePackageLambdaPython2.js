...
/**
 * Action: Code Package: Lambda: Python2
...
module.exports = function(SPlugin, serverlessPath) {
  ...
  class CodePackageLambdaPython2 extends SPlugin {
    ...
    static getName() {
      return 'serverless.core.' + CodePackageLambdaPython2.name;
    }

    registerActions() {

      this.S.addAction(this.codePackageLambdaPython2.bind(this), {
        handler:       'codePackageLambdaPython2',
    ...
    /**
     * Code Package Lambda Python
     */

    codePackageLambdaPython2(evt) {
  ...
  class Packager {
    ...
    _createDistFolder(evt) {
      ...
      // todo: also copy in contents of lib directory
      wrench.copyDirSyncRecursive(
          evt.function.pathFunction,
  ...
  return( CodePackageLambdaPython2 );
};
