  ...
  class EndpointDeployApiGateway extends SPlugin {
      ...
      return BbPromise.try(function() {
        ...
        .each(function(f) {
          ...
          if (!updateId) {
            ...
            return _this._updateAuthorizer(f, fPopulated, updateId);
          }
        });
    }
    ...
    _createAuthorizer(f, fPopulated) {
      ...
      authorizer.authorizerUri = 'arn:aws:apigateway:'
        ...
        + ':function:'
        + f.getDeployedName({ stage: _this.evt.options.stage, region: _this.evt.options.region })
        + ':'
        + alias
        + '/invocations';
    ...
    _updateAuthorizer(f, fPopulated, updateId) {
      ...
      // Perform update
      return _this.provider.request('APIGateway', 'updateAuthorizer', params, _this.evt.options.stage, _this.evt.options.region)
        .then(function(a) {
          _this.authorizers[f.name] = a.id;
        });
    }
