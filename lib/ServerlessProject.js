        ...
        if (SUtils.fileExistsSync(path.join(_this._S.config.projectPath, c, 's-component.json'))) {
          ...
          return component.load()
            .then(function (instance) {
              ...
              return fs.readdirSync(_this._S.config.path.join(_this._S.config.projectPath, c));
            })
            .each(function(sf) {
              ...
              if (SUtils.fileExistsSync(path.join(_this._S.config.projectPath, c, sf, 's-module.json'))) {
                let moduleJson = SUtils.readAndParseJsonSync(path.join(_this._S.config.projectPath, c, 's-module.json'));
