...
class Function extends SerializerFileSystem {
  ...
  constructor(S, component, rootPath, name) {
    super(S);
    ...
    _this.name          = name || 'function' + SUtils.generateShortId(6);
    ...
    _this._templates     = new this._S.classes.Templates(this._S, this);
  }
  ...
  toObjectPopulated(options) {
    ...
    // Populate
    return SUtils.populate(this.getProject().getVariables(), this.getTemplates().toObject(), this.toObject(), options.stage, options.region);
  }
