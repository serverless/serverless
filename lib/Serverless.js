...
class Serverless {
  ...
  constructor(projectPath, config) {
    ...
    this.classes = {
      ...
      Stage:        require('./ServerlessStage'),
      Region:       require('./ServerlessRegion')
    };
  ...
  setProject( project ) {
    ...
    if( _.isString( project ) ){
      projectPath = _this.classes.Project.findProjectPath( project );
      project = new _this.classes.Project( projectPath, _this );
    }
  ...
  init() {
    ...
    if( _this._projectPath != undefined ){
      _this._project = new _this.classes.Project( _this._projectPath, _this );
    }

    return BbPromise.try(function(){
      if( _this.hasProject() ){
        return _this.state.load();
      }
    }).then(function(){
      if (_this.hasProject()) {
  ...
  initProviders() {
    this._providers.aws = new this.classes.ProviderAws(this, this.config);
  }
