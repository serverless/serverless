...
class Serverless {
            ...
            return _this._project.load()
                .then(function() {
                  ...
                  require('dotenv').config({
                    ...
                    path:   path.join(_this.getProject().getFilePath(), 'admin.env')
                  });
              });
          }
        })
  ...
  loadProjectPlugins() {
    if( this.hasProject() ) {
      this._loadPlugins( this.getProject().getFilePath(), this.getProject().getAllPlugins() );
    }
  }
