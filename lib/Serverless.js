...
class Serverless {
  ...
  reInitialize() {
    ...
    console.log('this interactive:', this.interactiveCli)
    getServerlessConfigFile.cache.delete(this);
    return getServerlessConfigFile(this)
      .then(serverlessConfigFile => {
        this.pluginManager.serverlessConfigFile = serverlessConfigFile;
        return this.service.load();
      })
      .then(() => this.variables.populateService())
      .then(() => {
        console.log('this interactive:', this.interactiveCli)

        this.service.mergeArrays();
        this.service.setFunctionNames();
        this.service.validate();
      });
  }
