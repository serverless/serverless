...
CMD.prototype._setRegions = Promise.method(function() {
  ...
  if (_this._region) { //user specified specific region to deploy to
    _this._regions = [utils.getProjRegionConfigForStage(_this._JAWS._meta.projectJson, _this._stage, _this._region)];
  } else {
