 ...
 * @constructor
 */
var CMD = function(projectJson, projectRootPath, stage, region) {
...
/**
 * Collect Lambdas & Endpoints
 */
CMD.prototype._collectLambdasAndEndpoints = Promise.method(function() {
    var _this = this;

    return utils.findAllLambdas(_this._projectRootPath)
        .then(function(lambdas) {
          _this._lambdas = lambdas;
        })
        .then(function() {
          return utils.findAllEndpoints(_this._projectRootPath);
        })
...
CMD.prototype.run = Promise.method(function() {
  ...
  return _this._promptStage()
      ...
      .then(_this._collectLambdasAndEndpoints)
      .then(function() {
