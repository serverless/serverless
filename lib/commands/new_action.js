...
CMD.prototype.run = Promise.method(function() {
  ...
  return Promise.try(function() {
      ...
      .then(function() {
        JawsCLI.log('Successfully created lambdas/'
...
CMD.prototype._createSkeleton = Promise.method(function() {
  ...
  if (!_this._JAWS._meta.projectRootPath) {
    throw new JawsError('Must be in a JAWS project', JawsError.errorCodes.UNKNOWN);
  }
