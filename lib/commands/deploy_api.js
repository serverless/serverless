        ...
        if (typeof endpoint.lambda !== 'undefined') {
          ...
          var integrationBody = {
            ...
            "uri" : "arn:aws:apigateway:"
                    ...
                    + "/invocations",
            "credentials" : null,
            "requestParameters" :   endpoint.endpoint.intRequestParameters || {},
            "requestTemplates" :    endpoint.endpoint.intRequestTemplates || {},
            "cacheNamespace" :      endpoint.endpoint.cacheNamespace || null,
            "cacheKeyParameters" :  endpoint.endpoint.cacheKeyParameters || []
          };
        } else {
          reject(new JawsError(
              'API Gateway integration currently supports lambdas only',
              JawsError.errorCodes.UNKNOWN));
        }

        // Create Integration
        client.createIntegration(state.restApiId, endpoint.endpoint.apig.resource.id, endpoint.endpoint.method, integrationBody)
            .then(function(response) {
