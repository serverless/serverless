...
const CMD = class StageRegion extends ProjectCmd {
  ...
  _validate() {
    ...
    if (!_this._JAWS._projectJson.stages) {
    ...
    if (_this._type === 'stage') {
      ...
      if (_this._JAWS._projectJson.stages[_this._stage]) {
    ...
    if (_this._type === 'region') {
      ...
      if (_this._JAWS._projectJson.stages[_this._stage].some(function(r) {
...
JAWS_DATA_MODEL_STAGE=${stage}`;
  ...
  _updateProjectJson() {
    ...
    if (_this._JAWS._projectJson.stages[_this._stage]) {
      _this._JAWS._projectJson.stages[_this._stage].push(regionObj);
    } else {
      _this._JAWS._projectJson.stages[_this._stage] = [regionObj];
    }
