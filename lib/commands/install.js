...
/**
 * Save CF Template Snippet
 */

function _saveCfTemplate() {
...
module.exports = function(JAWS) {
  ...
  JAWS.install = function(url, save, provision) {
    console.log(url, save, provision);
    return _installFiles(url)
  };
};
