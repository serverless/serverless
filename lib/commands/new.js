...
function _createCfStack() {
  ...
  var message = 'JAWS is now going to create an AWS CloudFormation Stack for the "' + project.stages[0] +
          ...
          async.whilst(
              ...
              function(callback) {
                ...
                setTimeout(function() {
                  ...
                  AWSUtils.cfDescribeStacks(project.awsProfile, project.regions[0], cfData.StackId)
                      .then(function(data) {
                        stackData = data;
...
function _createProjectJson(iamRoleData) {
  ...
  console.log('Your JAWS project hass been successfully created in the current directory.');
