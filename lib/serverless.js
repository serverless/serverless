...
import CLI from 'serverless/lib/classes/cli.js'
import Config from 'serverless/lib/classes/config.js'
import YamlParser from 'serverless/lib/classes/yaml-parser.js'
import PluginManager from 'serverless/lib/classes/plugin-manager.js'
import Utils from 'serverless/lib/classes/utils.js'
import Service from 'serverless/lib/classes/service.js'
import ConfigSchemaHandler from 'serverless/lib/classes/config-schema-handler/index.js'
import ServerlessError from 'serverless/lib/serverless-error.js'
import isStandaloneExecutable from 'serverless/lib/utils/is-standalone-executable.js'
import logDeprecation from 'serverless/lib/utils/log-deprecation.js'
import commmandsSchema from 'serverless/lib/cli/commands-schema.js'
import { parseEntries } from 'serverless/lib/configuration/variables/resolve-meta.js'
