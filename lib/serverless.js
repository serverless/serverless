...
class Serverless {
   ...
   * @param {string} options.globalDeploymentBucketName - The global deployment bucket name.
  ...
  constructor({
    ...
    service = {},
    credentialProviders = {},
    globalDeploymentBucketName = null,
    compose = {},
  } = {}) {
    ...
    this.globalDeploymentBucketName = globalDeploymentBucketName
    this.compose = {
    ...
    this.config.region = this.credentialProviders.aws().region
